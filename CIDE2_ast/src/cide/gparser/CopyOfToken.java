...
// EINGEFÜGT
	...
	/**
	 * helper function, returns position of the last character
	 */
	...
	/**
	 * helper function, sets the length. must be called after the offset is set
	 */
...
//EINGEFÜGT
	 ...
	 * field is null.
	 */
	public CopyOfToken specialToken;
	 ...
	 */
	public static final CopyOfToken newToken(int ofKind) {
		switch (ofKind) {
		default:
			return new CopyOfToken();
		}
	}
