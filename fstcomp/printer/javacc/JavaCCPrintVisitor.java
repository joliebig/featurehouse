...
import de.ovgu.cide.fstgen.parsers.generated_javacc.SimplePrintVisitor;

public class JavaCCPrintVisitor extends ArtifactPrintVisitor {

	public JavaCCPrintVisitor() {
		super("JavaCC-File");
	}
