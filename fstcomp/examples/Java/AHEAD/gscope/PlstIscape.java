...
//**************************************************
// PlstIscape extension class
//**************************************************
    
public class PlstIscape {
    ...
    public  AstNode setParms( Environment env,  AstTokenInterface _arg0 ) {
        ...
        myAlias = elem._alias;
        return ( PlstIscape ) this ;
    }

    public void doPatch() {
        AstNode alias_ast;

        if ( ! ( myAlias instanceof AST_ParList ) ) {
            System.err.println( "Didn't do patch - alias is " +
                                                   myAlias.getClass().getName() );
            System.err.println( "AST_ParList required for alias.\n" );
            return;
        }
    ...
    public void reduce2ast( AstProperties props ) {
        ...
        if ( props.getProperty( "env" ) == null ) {
            ...
            AstNode.fatalError( tok[0],
                                 "Implicit ParList escape must be in constructor" );
        }
