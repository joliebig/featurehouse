...
public class NSmDecl extends NestedSmDeclaration {
    ...
    public SmDeclaration getSmDeclaration () {
        
        return (SmDeclaration) arg [1] ;
    }
    ...
    public NSmDecl setParms (AstOptNode arg0, SmDeclaration arg1) {
        
        arg = new AstNode [ARG_LENGTH] ;
        tok = new AstTokenInterface [TOK_LENGTH] ;
        
        arg [0] = arg0 ;            /* [ AST_Modifiers ] */
        arg [1] = arg1 ;            /* SmDeclaration */
