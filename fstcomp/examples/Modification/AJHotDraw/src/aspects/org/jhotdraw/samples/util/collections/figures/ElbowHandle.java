...
public  class  ElbowHandle  extends AbstractHandle {
		...
		public ElbowHandle(LineConnection owner, int segment) {	super(owner);	fSegment = segment;	}

		public void invokeStart(int x, int y, DrawingView view) {	fLastX = x;	fLastY = y;	}
		...
		private boolean isVertical(Point p1, Point p2) {	return p1.x == p2.x;	}
		...
		private LineConnection ownerConnection() {	return (LineConnection)owner();	}
