...
import java.awt.*; 
import java.util.List; // JUnitDoclet begin import
...
public  class  PertDependency  extends LineConnection {
		...
		public PertDependency() {	setEndDecoration(new ArrowTip());	setStartDecoration(null);	}
		...
		public HandleEnumeration handles() {	List handles = super.handles().toList();	handles.set(0, new NullHandle(this, PolyLineFigure.locator(0)));	return new HandleEnumerator(handles);	}
