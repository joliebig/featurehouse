 ...
 * Registration of Command listeners (CB), listener role (RSI),...
 */
public class CTXCommandMenu extends JMenu implements ActionListener /*@AJHD refactored , CommandListener*/ {
