 ...
 * Command listener registration (CB), listener role (RSI), ... 
 */
public  class CommandMenu extends JMenu implements ActionListener /*@AJHD refactored , CommandListener*/ {
	...
	protected void addMenuItem(Command command, JMenuItem m) {
		...
		add(m);
//		@AJHD refactored : registration of Command listeners
//		This registration call will be introduced by an after advice, 
//		so the order of the	original last two calls is changed.
