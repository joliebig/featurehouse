...
//	AJHD: the class implements the subject role (Observer pattern) 
//	for the figure selection - see org.jhotdraw.observselection.FigureSelectionSubjectRole 
//	/**
...
//		AJHD: org.jhotdraw.observselection.FigureSelectionSubjectRole
...
//		addFigureSelectionListener(editor());
	 ...
	 */
	/*
	 * @AJHD: org.jhotdraw.observselection.SelectionChangedNotification
	 */
...
//		}
	 ...
	 */
	/*
	 * @AJHD: removed the notification call (fireSelectionChanged())
	 * see org.jhotdraw.observselection.SelectionChangedNotification
	 */
...
//	}
	...
	public class DrawingViewKeyListener implements KeyListener {
		...
		protected Command createDeleteCommand() {
			return new /*@AJHD UndoableCommand(new*/ DeleteCommand("Delete", editor())/*)*/;
		}
    }
