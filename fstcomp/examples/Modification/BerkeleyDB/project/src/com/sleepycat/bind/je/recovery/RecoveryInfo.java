...
public  class  RecoveryInfo {
	 ...
	 private void appendLsn__wrappee__base( StringBuffer sb, String name, long lsn){ if (lsn != DbLsn.NULL_LSN) { sb.append(name).append(DbLsn.getNoFormatString(lsn)); } }

	 private void appendLsn( StringBuffer sb, String name, long lsn){ t.in(Thread.currentThread().getStackTrace()[1].toString());	appendLsn__wrappee__base(); t.out(Thread.currentThread().getStackTrace()[1].toString()); }
