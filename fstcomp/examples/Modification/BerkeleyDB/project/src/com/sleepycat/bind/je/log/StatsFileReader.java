...
static  class  EntryInfo {
		 ...
		 EntryInfo(){ count=0; provisionalCount=0; totalBytes=0; minBytes=0; maxBytes=0; }
...
static  class  LogEntryTypeComparator  implements Comparator {
		 public int compare__wrappee__base( Object o1, Object o2){ if (o1 == null) { return -1; } if (o2 == null) { return 1; } if (o1 instanceof LogEntryType && o2 instanceof LogEntryType) { Byte t1=new Byte(((LogEntryType)o1).getTypeNum()); Byte t2=new Byte(((LogEntryType)o2).getTypeNum()); return t1.compareTo(t2); } else { throw new IllegalArgumentException("non LogEntryType passed to LogEntryType.compare"); } }

		 public int compare( Object o1, Object o2){ t.in(Thread.currentThread().getStackTrace()[1].toString());	compare__wrappee__base(); t.out(Thread.currentThread().getStackTrace()[1].toString()); }
