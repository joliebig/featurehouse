...
public  class  RunRecoveryException  extends DatabaseException {
	 ...
	 private void invalidate( EnvironmentImpl env){ if (env != null) { env.invalidate(this); } }

	 public void setAlreadyThrown(){ alreadyThrown=true; }

	 public String toString(){ if (alreadyThrown) { return "Environment invalid because of previous exception: " + super.toString(); } else { return super.toString(); } }
