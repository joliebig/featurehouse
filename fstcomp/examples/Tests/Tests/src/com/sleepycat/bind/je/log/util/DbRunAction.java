...
@MethodObject static  class  DbRunAction_main {
		 ...
		 protected void hook839() throws Exception { usage(); System.exit(1); }

		 protected void hook840() throws Exception { }

		 protected void hook841() throws Exception { if (action.equalsIgnoreCase("checkpoint")) { doAction=CHECKPOINT; } else { this.hook846(); } }

		 protected void hook842() throws Exception { }

		 protected void hook843() throws Exception { this.hook839(); }

		 protected void hook844() throws Exception { }

		 protected void hook845() throws Exception { }

		 protected void hook846() throws Exception { this.hook843(); }
