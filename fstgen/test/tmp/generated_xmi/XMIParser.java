/* Generated By:JavaCC: Do not edit this line. XMIParser.java */
...
public class XMIParser extends AbstractFSTParser implements XMIParserConstants {
  ...
  final public FSTInfo STag(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      n = Attribute(inTerminal);
                                                                                                               replaceName("Attribute", n);
                                                                                                                                              replaceName(n);
    }
    jj_consume_token(ELEMENT_END);
                                                                                                                                                                                {if (true) return productionEndNonTerminal("STag","-","{ElementId}_{Attribute}");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Attribute(boolean inTerminal) throws ParseException {
    ...
    t = jj_consume_token(ATTR_VAL);
                                                                                                      replaceName(new FSTInfo("<ATTR_VAL>",t.toString()));
                                                                                                                                                             {if (true) return productionEndTerminal("Attr_{<ATTR_NAME>}","{<ATTR_VAL>}","{<ATTR_VAL>}","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  public XMIParserTokenManager token_source;
  ...
  public XMIParser(CharStream stream) {
    token_source = new XMIParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public XMIParser(XMIParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(XMIParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
