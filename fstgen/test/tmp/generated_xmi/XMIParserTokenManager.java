/* Generated By:JavaCC: Do not edit this line. XMIParserTokenManager.java */
package tmp.generated_xmi;
import cide.gparser.CharStream;
import cide.gparser.Token;
import cide.gparser.TokenMgrError;
public class XMIParserTokenManager implements XMIParserConstants
{
...
public XMIParserTokenManager(CharStream stream){
   input_stream = stream;
}
public XMIParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
