...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor  {
	...
	protected boolean isSubtype(String type, String expectedType) {
		...
		if (type.equals("Expr14") && expectedType.equals("Expr")) return true;
		if (type.equals("Scope4") && expectedType.equals("Scope")) return true;
		...
		if (type.equals("Expr5") && expectedType.equals("Expr")) return true;
		if (type.equals("DigitNo05") && expectedType.equals("DigitNo0")) return true;
		...
		if (type.equals("Expr15") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("DigitNo04") && expectedType.equals("DigitNo0")) return true;
		if (type.equals("Expr6") && expectedType.equals("Expr")) return true;
		if (type.equals("Expr12") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("Expr7") && expectedType.equals("Expr")) return true;
		if (type.equals("BinOp9") && expectedType.equals("BinOp")) return true;
		if (type.equals("DigitNo03") && expectedType.equals("DigitNo0")) return true;
		if (type.equals("Expr13") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("Expr8") && expectedType.equals("Expr")) return true;
		if (type.equals("FunDecl1") && expectedType.equals("FunDecl")) return true;
		if (type.equals("DigitNo02") && expectedType.equals("DigitNo0")) return true;
		if (type.equals("Expr2") && expectedType.equals("Expr")) return true;
		if (type.equals("BinOp17") && expectedType.equals("BinOp")) return true;
		if (type.equals("Expr10") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("DigitNo01") && expectedType.equals("DigitNo0")) return true;
		if (type.equals("Expr19") && expectedType.equals("Expr")) return true;
		if (type.equals("Expr9") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("DigitNo08") && expectedType.equals("DigitNo0")) return true;
		...
		if (type.equals("Expr1") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("Expr11") && expectedType.equals("Expr")) return true;
		if (type.equals("Scope1") && expectedType.equals("Scope")) return true;
		if (type.equals("Expr18") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("DigitNo09") && expectedType.equals("DigitNo0")) return true;
		...
		if (type.equals("Expr4") && expectedType.equals("Expr")) return true;
		if (type.equals("DigitNo06") && expectedType.equals("DigitNo0")) return true;
		...
		if (type.equals("Expr17") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("Expr3") && expectedType.equals("Expr")) return true;
		...
		if (type.equals("Expr16") && expectedType.equals("Expr")) return true;
		if (type.equals("DigitNo07") && expectedType.equals("DigitNo0")) return true;
