...
public class CApproxParser extends AbstractFSTParser implements CApproxParserConstants {
    ...
    if (jj_2_2(2)) {
      n = PPIncludeStatement(true);
                                                 replaceName("PPIncludeStatement", n);
                                                                                         replaceName(n);
                                                                                                           {if (true) return productionEndTerminal("Include","{PPIncludeStatement}","{PPIncludeStatement}","Replacement",first,token);}
    } else if (jj_2_3(2)) {
      n = PPDefineStatement(true);
                                                replaceName("PPDefineStatement", n);
                                                                                       replaceName(n);
                                                                                                         {if (true) return productionEndTerminal("Define","{PPDefineStatement}","{PPDefineStatement}","Replacement",first,token);}
    } else if (jj_2_4(2)) {
      n = PPIfDef_TopLevel(inTerminal);
                                                     replaceName("PPIfDef_TopLevel", n);
                                                                                           replaceName(n);
                                                                                                             {if (true) return productionEndNonTerminal("IfDefTL","{PPIfDef_TopLevel}","{PPIfDef_TopLevel}");}
    } else if (jj_2_5(2)) {
      ...
      n = PPOtherIgnore(true);
                                                replaceName("PPOtherIgnore", n);
                                                                                   replaceName(n);
      findLineEnd();
                                                                                                                   {if (true) return productionEndTerminal("Preprocessor","{PPOtherIgnore}","{PPOtherIgnore}","Replacement",first,token);}
    } else if (jj_2_6(2147483647)) {
      n = Function(true);
                                                      replaceName("Function", n);
                                                                                    replaceName(n);
                                                                                                      {if (true) return productionEndTerminal("Func","{Function}","{Function}","JavaMethodOverriding",first,token);}
    } else {
      ...
      case TYPEDEF:
        n = TypeDef(true);
                         replaceName("TypeDef", n);
                                                      replaceName(n);
                                                                        {if (true) return productionEndTerminal("TypeDef_","{TypeDef}","{TypeDef}","Replacement",first,token);}
        break;
      default:
        jj_la1[0] = jj_gen;
        if (jj_2_7(3)) {
          ...
          n = Sequence_CodeUnit_TypeLevel(inTerminal);
                                                                                                                                        replaceName(n);
          ...
          case OTHER:
            n = Statement(true);
                           replaceName("Statement", n);
                                                          replaceName(n);
                                                                            {if (true) return productionEndTerminal("StmtTL","{Statement}","{Statement}","Replacement",first,token);}
            break;
          default:
            jj_la1[1] = jj_gen;
            jj_consume_token(-1);
  ...
  final public FSTInfo CodeUnit_TypeLevel(boolean inTerminal) throws ParseException {
                                                   Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_9(2)) {
      n = PPIfDef_TypeLevel(inTerminal);
                                                      replaceName(n);
                                                                        {if (true) return productionEndNonTerminal("IfDefYL","PPIfDef_TypeLevel}","PPIfDef_TypeLevel}");}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LITERAL:
      case INCLUDE:
      ...
      case OTHER:
        n = Statement(true);
                           replaceName("Statement", n);
                                                          replaceName(n);
                                                                            {if (true) return productionEndTerminal("StmtYL","{Statement}","{Statement}","Replacement",first,token);}
        break;
      default:
        jj_la1[2] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo Sequence_CodeUnit_TypeLevel(boolean inTerminal) throws ParseException {
                                                            Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    label_2:
    while (true) {
      ...
      n = CodeUnit_TypeLevel(inTerminal);
                                                        replaceName(n);
    }
                                                                            {if (true) return productionEndNonTerminal("Sequence_CodeUnit_TypeLevel","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo CodeUnit_InBlock(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_11(2)) {
      ...
      n = PPOtherIgnore(true);
                                                replaceName(n);
      findLineEnd();
                                                                                {if (true) return productionEndTerminal("PreprocessorBL","-","-","Replacement",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IF:
        n = IfStatement(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("If","-","-","Replacement",first,token);}
        break;
      case FOR:
        n = ForStatement(true);
                                           replaceName(n);
                                                             {if (true) return productionEndTerminal("For","-","-","Replacement",first,token);}
        break;
      case WHILE:
        n = WhileStatement(true);
                                             replaceName(n);
                                                               {if (true) return productionEndTerminal("While","-","-","Replacement",first,token);}
        break;
      case DO:
        n = DoStatement(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("Do","-","-","Replacement",first,token);}
        break;
      case SWITCH:
      ...
      default:
        ...
        if (jj_2_15(2)) {
          ...
          case OCB:
            n = Block(true);
                                    replaceName(n);
                                                      {if (true) return productionEndTerminal("Blck","-","-","Replacement",first,token);}
            break;
          case LITERAL:
          case INCLUDE:
          case DEFINE:
  ...
  final public FSTInfo ElseBlock(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(ELSE);
                 {if (true) return productionEndTerminal("ElseBlock","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo SwCase(boolean inTerminal) throws ParseException {
    ...
    case SWDEFAULT:
      ...
      n = Sequence_CodeUnit_InBlock(true);
                                                         replaceName(n);
                                                                           {if (true) return productionEndTerminal("SwCase1","-","-","Replacement",first,token);}
      break;
    case CASE:
  ...
  final public FSTInfo SwCaseLabel(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("SwCaseLabel1","-","-","Replacement",first,token);}
      break;
    case LITERAL:
    case OTHER:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public FSTInfo MoreSwCaseLabel(boolean inTerminal) throws ParseException {
    ...
    n = SwCaseLabel(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("MoreSwCaseLabel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ExternDecl(boolean inTerminal) throws ParseException {
    ...
    n = Block(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("ExternDecl","-","{TOSTRING}","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo PPIncludeStatement(boolean inTerminal) throws ParseException {
    ...
    findLineEnd();
                                     {if (true) return productionEndTerminal("PPIncludeStatement","-","{TOSTRING}","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo PPDefineStatement(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_16(2)) {
      ...
      findLineEnd();
                                                {if (true) return productionEndTerminal("PPDefineStatement2","-","{TOSTRING}","Replacement",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo PPIfDef_TopLevel(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      n = IfElseIf_TopLevel(inTerminal);
                                                                                                                                                            replaceName(n);
    }
    if (jj_2_19(2)) {
      n = PPIfDef_TopLevel_Else(inTerminal);
                                                                                                                                                                                                                                  replaceName(n);
    } else {
      ;
    }
    ...
    jj_consume_token(ENDIF);
                                                                                                                                                                                                                                                                 {if (true) return productionEndNonTerminal("PPIfDef_TopLevel","-","-");}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo PPIfDef_TopLevel_Else(boolean inTerminal) throws ParseException {
                                                      Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(HASH);
    jj_consume_token(ELSE);
    n = Sequence_CodeUnit_TopLevel(inTerminal);
                                                             replaceName(n);
                                                                               {if (true) return productionEndNonTerminal("PPIfDef_TopLevel_Else","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo PPIfDef_BlockLevel(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_21(2)) {
      n = IfElseIf_BlockLevel_Else(true);
                                                                                                                                                                                                              replaceName(n);
    } else {
      ;
    }
    jj_consume_token(HASH);
    jj_consume_token(ENDIF);
                                                                                                                                                                                                                                             {if (true) return productionEndTerminal("PPIfDef_BlockLevel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo PPIfDef_TypeLevel(boolean inTerminal) throws ParseException {
                                                  Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = IfDefLine(inTerminal);
                                 replaceName(n);
    ...
    while (true) {
      ...
      n = IfElseIf_TypeLevel(inTerminal);
                                                                                                                                                              replaceName(n);
    }
    if (jj_2_23(2)) {
      n = IfElseIf_TypeLevel_Else(inTerminal);
                                                                                                                                                                                                                                      replaceName(n);
    } else {
      ;
    }
    jj_consume_token(HASH);
    jj_consume_token(ENDIF);
                                                                                                                                                                                                                                                                     {if (true) return productionEndNonTerminal("PPIfDef_TypeLevel","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo PPOtherIgnore(boolean inTerminal) throws ParseException {
    ...
    case PPLINE:
      jj_consume_token(PPLINE);
                 {if (true) return productionEndTerminal("PPOtherIgnore1","-","{TOSTRING}","Replacement",first,token);}
      break;
    case PPPRAGMA:
      jj_consume_token(PPPRAGMA);
                   {if (true) return productionEndTerminal("PPOtherIgnore2","-","{TOSTRING}","Replacement",first,token);}
      break;
    case PPERROR:
  ...
  final public FSTInfo IfDefLine(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_24(2)) {
      ...
      jj_consume_token(IDENTIFIER);
                                                {if (true) return productionEndTerminal("IfDefLine2","-","-","Replacement",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case HASH:
        jj_consume_token(HASH);
  ...
  final public FSTInfo IfElseIf_TopLevel(boolean inTerminal) throws ParseException {
    ...
    n = Sequence_CodeUnit_TopLevel(true);
                                                                                             replaceName(n);
                                                                                                               {if (true) return productionEndTerminal("IfElseIf_TopLevel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo IfElseIf_TypeLevel(boolean inTerminal) throws ParseException {
                                                   Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = IfElseIf(true);
                          replaceName(n);
    findLineEnd();
    n = Sequence_CodeUnit_TypeLevel(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("IfElseIf_TypeLevel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo IfElseIf_BlockLevel(boolean inTerminal) throws ParseException {
    ...
    n = Sequence_CodeUnit_InBlock(true);
                                                                                            replaceName(n);
                                                                                                              {if (true) return productionEndTerminal("IfElseIf_BlockLevel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo IfElseIf_BlockLevel_Else(boolean inTerminal) throws ParseException {
                                                         Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(HASH);
    jj_consume_token(ELSE);
    n = Sequence_CodeUnit_InBlock(inTerminal);
                                                            replaceName(n);
                                                                              {if (true) return productionEndNonTerminal("IfElseIf_BlockLevel_Else","-","-");}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo IfElseIf_TypeLevel_Else(boolean inTerminal) throws ParseException {
                                                        Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(HASH);
    jj_consume_token(ELSE);
    n = Sequence_CodeUnit_TypeLevel(inTerminal);
                                                              replaceName(n);
                                                                                {if (true) return productionEndNonTerminal("IfElseIf_TypeLevel_Else","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Function(boolean inTerminal) throws ParseException {
    ...
    n = BlockOrSemi(true);
                                                                                                                                                                                                           replaceName(n);
                                                                                                                                                                                                                             {if (true) return productionEndTerminal("Function","-","{FunctionHeader}({FunctionParameterList})","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FunctionHeader(boolean inTerminal) throws ParseException {
    ...
    t = jj_consume_token(IDENTIFIER);
                                                                                                                                                                               replaceName(new FSTInfo("<IDENTIFIER>",t.image));
    jj_consume_token(OB);
                                                                                                                                                                                                                                       {if (true) return productionEndTerminal("FunctionHeader","-","{<IDENTIFIER>}","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FunctionReturnType(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
                                                           {if (true) return productionEndTerminal("FunctionReturnType","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FunctionExoticStuff(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(LITERAL);
    jj_consume_token(CB);
                                       {if (true) return productionEndTerminal("FunctionExoticStuff","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = FunctionParameter(true);
                                                                                    replaceName(n);
                                                                                                        ...
                                                                                                        {if (true) return productionEndTerminal("FunctionParameterList","-","{TOSTRING}","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo GotoLabel(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
    jj_consume_token(COLON);
                          {if (true) return productionEndTerminal("GotoLabel","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = CodeUnit_InBlock(true);
                                                replaceName(n);
                                                                    ...
                                                                    {if (true) return productionEndTerminal("Sequence_CodeUnit_InBlock","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo BlockOrSemi(boolean inTerminal) throws ParseException {
    ...
    case SEMI:
      jj_consume_token(SEMI);
                           {if (true) return productionEndTerminal("BlockOrSemi1","-","-","Replacement",first,token);}
      break;
    case OCB:
      n = Block(true);
                                    replaceName(n);
                                                      {if (true) return productionEndTerminal("BlockOrSemi2","-","-","Replacement",first,token);}
      break;
    case LITERAL:
    case PPLINE:
    case PPPRAGMA:
  ...
  final public FSTInfo BlockOrSingleStatement(boolean inTerminal) throws ParseException {
    ...
    case OCB:
      n = Block(true);
                                    replaceName(n);
                                                      {if (true) return productionEndTerminal("BlockOrSingleStatement1","-","-","Replacement",first,token);}
      break;
    case LITERAL:
    case INCLUDE:
    case DEFINE:
  ...
  final public FSTInfo TypeDef(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_28(2)) {
      ...
      jj_consume_token(SEMI);
                                                                                        {if (true) return productionEndTerminal("TypeDef1","-","{TOSTRING}","Replacement",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case TYPEDEF:
        jj_consume_token(TYPEDEF);
  ...
  final public FSTInfo BlockAssignment(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(OCB);
    findEndCCB();
                                                               {if (true) return productionEndTerminal("BlockAssignment","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo EnumBlock(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(OCB);
    findEndCCB();
                                                {if (true) return productionEndTerminal("EnumBlock","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Cast(boolean inTerminal) throws ParseException {
    ...
    n = FunctionReturnType(true);
                                        replaceName(n);
    jj_consume_token(CB);
                                                              {if (true) return productionEndTerminal("Cast","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo AnyTypeDefToken(boolean inTerminal) throws ParseException {
    ...
    case OCB:
      jj_consume_token(OCB);
                           {if (true) return productionEndTerminal("AnyTypeDefToken1","-","-","Replacement",first,token);}
      break;
    case CCB:
      jj_consume_token(CCB);
              {if (true) return productionEndTerminal("AnyTypeDefToken2","-","-","Replacement",first,token);}
      break;
    case LITERAL:
    case INCLUDE:
    case DEFINE:
  ...
  final public FSTInfo AnyStmtToken(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("AnyStmtToken1","-","-","Replacement",first,token);}
      break;
    case LITERAL:
      jj_consume_token(LITERAL);
                   {if (true) return productionEndTerminal("AnyStmtToken2","-","-","Replacement",first,token);}
      break;
    case OTHER:
      jj_consume_token(OTHER);
                 {if (true) return productionEndTerminal("AnyStmtToken3","-","-","Replacement",first,token);}
      break;
    case COMMA:
      jj_consume_token(COMMA);
              {if (true) return productionEndTerminal("AnyStmtToken4","-","-","Replacement",first,token);}
      break;
    case PIPE:
      jj_consume_token(PIPE);
              {if (true) return productionEndTerminal("AnyStmtToken5","-","-","Replacement",first,token);}
      break;
    case LT:
      jj_consume_token(LT);
              {if (true) return productionEndTerminal("AnyStmtToken6","-","-","Replacement",first,token);}
      break;
    case GT:
      jj_consume_token(GT);
              {if (true) return productionEndTerminal("AnyStmtToken7","-","-","Replacement",first,token);}
      break;
    case OB:
      jj_consume_token(OB);
              {if (true) return productionEndTerminal("AnyStmtToken8","-","-","Replacement",first,token);}
      break;
    case CB:
      jj_consume_token(CB);
              {if (true) return productionEndTerminal("AnyStmtToken9","-","-","Replacement",first,token);}
      break;
    case OCB:
      n = Block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("AnyStmtToken10","-","-","Replacement",first,token);}
      break;
    case IF:
      jj_consume_token(IF);
               {if (true) return productionEndTerminal("AnyStmtToken11","-","-","Replacement",first,token);}
      break;
    case ELSE:
      jj_consume_token(ELSE);
                 {if (true) return productionEndTerminal("AnyStmtToken12","-","-","Replacement",first,token);}
      break;
    case FOR:
      jj_consume_token(FOR);
                {if (true) return productionEndTerminal("AnyStmtToken13","-","-","Replacement",first,token);}
      break;
    case WHILE:
      jj_consume_token(WHILE);
    ...
    default:
      ...
      if (jj_2_29(3)) {
        ...
        case ENUM:
          jj_consume_token(ENUM);
                 {if (true) return productionEndTerminal("AnyStmtToken16","-","-","Replacement",first,token);}
          break;
        case STAR:
          jj_consume_token(STAR);
        ...
        default:
          ...
          if (jj_2_30(2147483647)) {
            ...
            case EQ:
              jj_consume_token(EQ);
              {if (true) return productionEndTerminal("AnyStmtToken19","-","-","Replacement",first,token);}
              break;
            case COLON:
              jj_consume_token(COLON);
              {if (true) return productionEndTerminal("AnyStmtToken20","-","-","Replacement",first,token);}
              break;
            case EXTERN:
            case STATIC:
            case INLINE:
            ...
            case WEIREDSTUFF2:
              n = Modifier(true);
                          replaceName(n);
                                            {if (true) return productionEndTerminal("AnyStmtToken21","-","-","Replacement",first,token);}
              break;
            case IFDEF:
              jj_consume_token(IFDEF);
                  {if (true) return productionEndTerminal("AnyStmtToken22","-","-","Replacement",first,token);}
              break;
            case IFNDEF:
              jj_consume_token(IFNDEF);
                   {if (true) return productionEndTerminal("AnyStmtToken23","-","-","Replacement",first,token);}
              break;
            case DEFINE:
              jj_consume_token(DEFINE);
                   {if (true) return productionEndTerminal("AnyStmtToken24","-","-","Replacement",first,token);}
              break;
            case INCLUDE:
              jj_consume_token(INCLUDE);
                    {if (true) return productionEndTerminal("AnyStmtToken25","-","-","Replacement",first,token);}
              break;
            case ELIF:
              jj_consume_token(ELIF);
                 {if (true) return productionEndTerminal("AnyStmtToken26","-","-","Replacement",first,token);}
              break;
            case ELSIF:
              jj_consume_token(ELSIF);
                  {if (true) return productionEndTerminal("AnyStmtToken27","-","-","Replacement",first,token);}
              break;
            case PPLINE:
            case PPPRAGMA:
            case PPERROR:
              n = PPOtherIgnore(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("AnyStmtToken28","-","-","Replacement",first,token);}
              break;
            case CONST:
              jj_consume_token(CONST);
                  {if (true) return productionEndTerminal("AnyStmtToken29","-","-","Replacement",first,token);}
              break;
            case STRUCT:
              jj_consume_token(STRUCT);
                   {if (true) return productionEndTerminal("AnyStmtToken30","-","-","Replacement",first,token);}
              break;
            case UNSIGNED:
              jj_consume_token(UNSIGNED);
  ...
  final public FSTInfo VarDecl(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMI);
                                                              {if (true) return productionEndTerminal("VarDecl","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo VarDeclTokenOrComma(boolean inTerminal) throws ParseException {
    ...
    case OTHER:
      n = VarDeclToken(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("VarDeclTokenOrComma1","-","-","Replacement",first,token);}
      break;
    case COMMA:
      jj_consume_token(COMMA);
  ...
  final public FSTInfo VarDeclToken(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("VarDeclToken1","-","-","Replacement",first,token);}
      break;
    case LITERAL:
      jj_consume_token(LITERAL);
                   {if (true) return productionEndTerminal("VarDeclToken2","-","-","Replacement",first,token);}
      break;
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("VarDeclToken3","-","-","Replacement",first,token);}
      break;
    case OTHER:
      jj_consume_token(OTHER);
                 {if (true) return productionEndTerminal("VarDeclToken4","-","-","Replacement",first,token);}
      break;
    case PIPE:
      jj_consume_token(PIPE);
              {if (true) return productionEndTerminal("VarDeclToken5","-","-","Replacement",first,token);}
      break;
    case CONST:
      jj_consume_token(CONST);
                  {if (true) return productionEndTerminal("VarDeclToken6","-","-","Replacement",first,token);}
      break;
    case STRUCT:
      jj_consume_token(STRUCT);
                   {if (true) return productionEndTerminal("VarDeclToken7","-","-","Replacement",first,token);}
      break;
    case UNSIGNED:
      jj_consume_token(UNSIGNED);
                     {if (true) return productionEndTerminal("VarDeclToken8","-","-","Replacement",first,token);}
      break;
    case ENUM:
      jj_consume_token(ENUM);
                 {if (true) return productionEndTerminal("VarDeclToken9","-","-","Replacement",first,token);}
      break;
    case PPLINE:
    case PPPRAGMA:
    case PPERROR:
      n = PPOtherIgnore(true);
                               replaceName(n);
                                                 {if (true) return productionEndTerminal("VarDeclToken10","-","-","Replacement",first,token);}
      break;
    case EXTERN:
    case STATIC:
    case INLINE:
    ...
    case WEIREDSTUFF2:
      n = Modifier(true);
                          replaceName(n);
                                            {if (true) return productionEndTerminal("VarDeclToken11","-","-","Replacement",first,token);}
      break;
    case OB:
      jj_consume_token(OB);
      findEndCB();
  ...
  final public FSTInfo Literal(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LITERAL);
                   {if (true) return productionEndTerminal("Literal","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
