/* Generated By:JavaCC: Do not edit this line. LHaskellParserTokenManager.java */
package tmp.generated_lhaskell;
import cide.gparser.CharStream;
import cide.gparser.Token;
import cide.gparser.TokenMgrError;
public class LHaskellParserTokenManager implements LHaskellParserConstants
{
...
public LHaskellParserTokenManager(CharStream stream){
   input_stream = stream;
}
public LHaskellParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
