/* Generated By:JavaCC: Do not edit this line. LHaskellParser.java */
...
import de.ovgu.cide.fstgen.ast.AbstractFSTParser;
  ...
  public class LHaskellParser extends AbstractFSTParser implements LHaskellParserConstants {
  ...
  final public FSTInfo moduleHeader(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(WHERE);
                                                                                             {if (true) return productionEndTerminal("moduleHeader","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = definition(true);
                                                                      replaceName(n);
                                                                                          ...
                                                                                          {if (true) return productionEndTerminal("definitions","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo definition(boolean inTerminal) throws ParseException {
    ...
    case LEFT_BRACKET:
      n = declaration(true);
                             replaceName(n);
                                               {if (true) return productionEndTerminal("definition7","-","-","Replacement",first,token);}
      break;
    default:
      jj_la1[24] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo constr(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_11(2147483647)) {
      ...
      jj_consume_token(RIGHT_CURLY);
                                                                                                                                                                   {if (true) return productionEndTerminal("constr1","-","-","Replacement",first,token);}
      ...
      while (true) {
        ...
        default:
          ...
          break label_10;
                                                                                                                                                                  ...
                                                                                                                                                                  {if (true) return productionEndTerminal("constr2","-","-","Replacement",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CONSTRUCTOR_ID:
      case LEFT_PAREN:
        ...
        while (true) {
          ...
          n = type(true);
                                                      replaceName(n);
                                                                          ...
                                                                          {if (true) return productionEndTerminal("constr3","-","-","Replacement",first,token);}
        break;
      default:
        jj_la1[30] = jj_gen;
        jj_consume_token(-1);
    ...
    while (true) {
      ...
      n = declaration(true);
                                                                        replaceName(n);
                                                                                            ...
                                                                                            {if (true) return productionEndTerminal("declarationList","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_15(2147483647)) {
      ...
      default:
        ...
        ;
                                                                                                                                                ...
                                                                                                                                                {if (true) return productionEndTerminal("declaration1","-","-","Replacement",first,token);}
      ...
      default:
        ...
        ;
                                                                                                                                                     ...
                                                                                                                                                     {if (true) return productionEndTerminal("declaration2","-","-","Replacement",first,token);}
      ...
      n = functiontype(true);
                                                                                                                                                        replaceName(n);
                                                                                                                                                                          {if (true) return productionEndTerminal("declaration3","-","-","Replacement",first,token);}
  ...
  final public FSTInfo function(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_20(2147483647)) {
      ...
      while (true) {
        ...
        n = patroon(true);
                                                                                                                     replaceName(n);
                                                                                                                                         ...
                                                                                                                                         {if (true) return productionEndTerminal("function1","-","-","Replacement",first,token);}
      ...
      while (true) {
        ...
        default:
          ...
          break label_17;
                                                                                                                   ...
                                                                                                                   {if (true) return productionEndTerminal("function2","-","-","Replacement",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OTHER2:
      case OTHER4:
      ...
      case LEFT_BRACKET:
        ...
        n = patr(true);
                                                                                           replaceName(n);
                                                                                                             {if (true) return productionEndTerminal("function3","-","-","Replacement",first,token);}
        break;
      default:
        jj_la1[48] = jj_gen;
        jj_consume_token(-1);
    ...
    while (true) {
      ...
      n = var(true);
                                                        replaceName(n);
                                                                            ...
                                                                            {if (true) return productionEndTerminal("varList","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo naam(boolean inTerminal) throws ParseException {
    ...
    n = qcon(true);
                      replaceName(n);
                                        {if (true) return productionEndTerminal("naam","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  public LHaskellParserTokenManager token_source;
  ...
  public LHaskellParser(CharStream stream) {
    token_source = new LHaskellParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public LHaskellParser(LHaskellParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(LHaskellParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
