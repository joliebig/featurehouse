...
public class JakParser extends AbstractFSTParser implements JakParserConstants {
  ...
  final public FSTInfo LayerDeclaration(boolean inTerminal) throws ParseException {
    ...
    n = Name(true);
                              replaceName(n);
    jj_consume_token(SEMICOLON);
                                                    {if (true) return productionEndTerminal("LayerDeclaration","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Modifier(boolean inTerminal) throws ParseException {
    ...
    case AT:
      n = Annotation(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("Modifier13","-","-","Replacement",first,token);}
      break;
    default:
      jj_la1[6] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo CastLAOp(boolean inTerminal) throws ParseException {
    ...
    case STRING_LITERAL:
      n = Literal(true);
                         replaceName(n);
                                           {if (true) return productionEndTerminal("CastLAOp9","-","-","Replacement",first,token);}
      break;
    default:
      jj_la1[91] = jj_gen;
      jj_consume_token(-1);
    ...
    default:
      ...
      if (jj_2_32(2147483647)) {
        ...
        case IDENTIFIER:
          n = Name(true);
                      replaceName(n);
                                        {if (true) return productionEndTerminal("PrimaryPrefix8","-","-","Replacement",first,token);}
          break;
        default:
          jj_la1[97] = jj_gen;
          jj_consume_token(-1);
    ...
    while (true) {
      ...
      n = ResultType(true);
                                                                      replaceName(n);
                                                                                          ...
                                                                                          {if (true) return productionEndTerminal("TypeList","-","-","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
