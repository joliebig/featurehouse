 ...
 */
public class Java15Parser extends AbstractFSTParser implements Java15ParserConstants {
        public Java15Parser(){}
  ...
  final public String ImportDeclaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
                                                                                                                                  {if (true) return productionEndTerminal("ImportDeclaration","{Name}{ImportPackage}","{Name}{ImportPackage}","error",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public String ImportPackage(boolean inTerminal) throws ParseException {
                                             Token first=null,t;String n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(DOT);
    jj_consume_token(STAR);
                  {if (true) return productionEndTerminal("ImportPackage","-",".*","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String Id(boolean inTerminal) throws ParseException {
                                  Token first=null,t;String n;
     first=getToken(1); productionStart(inTerminal);
    t = jj_consume_token(IDENTIFIER);
                        replaceName("<IDENTIFIER>",t.toString());
                                                                    {if (true) return productionEndTerminal("Id","{<IDENTIFIER>}","{<IDENTIFIER>}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String TypeDeclaration(boolean inTerminal) throws ParseException {
    ...
    case SEMICOLON:
      jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("EmptyTypeDecl","{AUTO}","{AUTO}","error",first,token);}
      break;
    default:
      jj_la1[14] = jj_gen;
  ...
  final public String ClassOrInterfaceBodyDeclaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_5(2)) {
      Initializer(true);
                                        {if (true) return productionEndTerminal("InitializerDecl","{AUTO}","{AUTO}","error",first,token);}
      ...
      ConstructorDeclaration(true);
                                                                                                                    {if (true) return productionEndTerminal("ConstructorDecl","{<IDENTIFIER>}","{<IDENTIFIER>}","error",first,token);}
    } else if (jj_2_9(2147483647)) {
      Modifiers(true);
      n = FieldDeclaration(true);
                                                                                                                               replaceName("FieldDeclaration",n);
                                                                                                                                                                    {if (true) return productionEndTerminal("FieldDecl","{FieldDeclaration}","{FieldDeclaration}","error",first,token);}
    } else if (jj_2_10(2)) {
      Modifiers(true);
      n = MethodDeclaration(true);
                                                                replaceName("MethodDeclaration",n);
                                                                                                      {if (true) return productionEndTerminal("MethodDecl","{MethodDeclaration}","{MethodDeclaration}","error",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case SEMICOLON:
        jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("EmptyDecl","{AUTO}","{AUTO}","error",first,token);}
        break;
      default:
        jj_la1[38] = jj_gen;
        jj_consume_token(-1);
  ...
  final public String FieldDeclaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
                                                                                                                                                                                              {if (true) return productionEndTerminal("FieldDeclaration","-","{Type}-{VariableDeclarator}^,","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String VariableDeclarator(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                               ...
                                                                                                               {if (true) return productionEndTerminal("VariableDeclarator","-","{VariableDeclaratorId}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String VariableDeclaratorId(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      jj_consume_token(RBRACKET);
                                                                                ...
                                                                                {if (true) return productionEndTerminal("VariableDeclaratorId","-","{<IDENTIFIER>}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String MethodDeclaration(boolean inTerminal) throws ParseException {
    ...
    MethodDeclarationBody(true);
                                                                                                                                                                     {if (true) return productionEndTerminal("MethodDeclaration","-","{MethodDeclarator}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String MethodDeclarator(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      jj_consume_token(RBRACKET);
                                                                                                                                              ...
                                                                                                                                              {if (true) return productionEndTerminal("MethodDeclarator","-","{<IDENTIFIER>}({FormalParameters})","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String FormalParameters(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
                                                                                                 {if (true) return productionEndTerminal("FormalParameters","-","{FormalParametersInternal}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String ConstructorDeclaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                                                                                                                                                                                                                                                                                                    {if (true) return productionEndTerminal("ConstructorDeclaration","-","{<IDENTIFIER>}-{FormalParameters}","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String ResultType(boolean inTerminal) throws ParseException {
    ...
    case VOID:
      jj_consume_token(VOID);
                 {if (true) return productionEndTerminal("ResultType1","-","-","error",first,token);}
      break;
    case BOOLEAN:
    case BYTE:
    case CHAR:
    ...
    case IDENTIFIER:
      Type(true);
                    {if (true) return productionEndTerminal("ResultType2","-","-","error",first,token);}
      break;
    default:
      jj_la1[65] = jj_gen;
      jj_consume_token(-1);
  ...
  final public String Block(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                                         {if (true) return productionEndTerminal("Block","-","-","error",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String AnnotationTypeMemberDeclaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_47(2147483647)) {
      ...
      jj_consume_token(SEMICOLON);
                                                                                                                                                                               {if (true) return productionEndTerminal("AnnotationMethodDecl","{<IDENTIFIER>}","{<IDENTIFIER>}","error",first,token);}
      ...
      default:
        ...
        if (jj_2_49(2)) {
          ...
          case AT:
            ...
            n = FieldDeclaration(true);
                                                               replaceName("FieldDeclaration",n);
                                                                                                    {if (true) return productionEndTerminal("AnnotationFieldDecl","{FieldDeclaration}","{FieldDeclaration}","error",first,token);}
            break;
          case SEMICOLON:
            jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("AnnoationEmptyDecl","{AUTO}","{AUTO}","error",first,token);}
            break;
          default:
            jj_la1[146] = jj_gen;
            jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x78,0x78,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x18,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1ffc000,0x78,0x2,0x4,0x400,0x800,0x200,0x1,0x1,0x0,0x10000000,0x10000000,0x2000,0x60,0x60,0x1180,0x1180,0x78,0x0,0x0,0x0,0x0,0x0,0x18,0x18,0x0,0x0,0x0,0x0,0x0,0x0,0x78,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x18,0x0,0x18,0x18,0x0,0x0,0x1ffc018,0x18,0x1ffc018,0x0,0x18,0x0,0x0,0x18,0x78,0x18,0x18,0x18,0x0,0x0,0x0,0x78,0x0,0x0,0x0,0x0,0x0,0x78,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
