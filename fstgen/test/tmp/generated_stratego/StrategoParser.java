...
public class StrategoParser extends AbstractFSTParser implements StrategoParserConstants {
  ...
  final public FSTInfo StringQuotation(boolean inTerminal) throws ParseException {
                                                Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INTEGER_LITERAL:
    ...
    case LOWLINE:
      n = Term(true);
                      replaceName(n);
                                        {if (true) return productionEndTerminal("StringQuotation1","-","-","Replacement","Default",first,token);}
      break;
    case SLASH:
    case COMMA:
    case SEMICOLON:
    ...
    case AT:
    case ASSIGN:
      n = SpecialStringQuotation(true);
                                        replaceName(n);
                                                          {if (true) return productionEndTerminal("StringQuotation2","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[148] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo SpecialStringQuotation(boolean inTerminal) throws ParseException {
                                                       Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
      jj_consume_token(COMMA);
              {if (true) return productionEndTerminal("SpecialStringQuotation1","-","-","Replacement","Default",first,token);}
      break;
    case DDOT:
      jj_consume_token(DDOT);
              {if (true) return productionEndTerminal("SpecialStringQuotation2","-","-","Replacement","Default",first,token);}
      break;
    case DOT:
      jj_consume_token(DOT);
              {if (true) return productionEndTerminal("SpecialStringQuotation3","-","-","Replacement","Default",first,token);}
      break;
    case SLASH:
      jj_consume_token(SLASH);
              {if (true) return productionEndTerminal("SpecialStringQuotation4","-","-","Replacement","Default",first,token);}
      break;
    case SEMICOLON:
      jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("SpecialStringQuotation5","-","-","Replacement","Default",first,token);}
      break;
    case ASSIGN:
      jj_consume_token(ASSIGN);
              {if (true) return productionEndTerminal("SpecialStringQuotation6","-","-","Replacement","Default",first,token);}
      break;
    case AT:
      jj_consume_token(AT);
              {if (true) return productionEndTerminal("SpecialStringQuotation7","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[149] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0xb500,0x0,0x0,0xe0800000,0xe0800000,0x0,0x0,0x0,0xb500,0x0,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x0,0x0,0xe0000000,0xe0000000,0x800000,0x0,0x0,0x0,0x0,0x40200,0x40200,0x0,0x0,0x0,0x0,0x0,0x800000,0x200000,0x0,0x100000,0x2000000,0x0,0xe0800000,0x0,0xd0e5ace,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd0e5ace,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd0e5ace,0x0,0x0,0x6420c,0x0,0x0,0x0,0xd0e5ace,0x0,0xd0e5ace,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1