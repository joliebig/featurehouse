...
public class JavaCCParser extends AbstractFSTParser implements JavaCCParserConstants {
  ...
  final public FSTInfo ParserNameS(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("ParserNameS","ParserNameS","ParserNameS","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ParserNameE(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("ParserNameE","ParserNameE","ParserNameE","Replacement",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo expansion_unit(boolean inTerminal) throws ParseException {
    ...
    case _LOOKAHEAD:
      ...
      n = local_lookahead(true);
                                                              replaceName(n);
      jj_consume_token(RPAREN);
                                                                                    {if (true) return productionEndTerminal("expansion_unit1","Block1","Block1","Replacement",first,token);}
      break;
    case LBRACE:
      n = Block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("expansion_unit2","Block2","Block2","ExpansionOverriding",first,token);}
      break;
    case LBRACKET:
      jj_consume_token(LBRACKET);
      n = expansion_choices(true);
                                       replaceName(n);
      jj_consume_token(RBRACKET);
                                                             {if (true) return productionEndTerminal("expansion_unit3","Block3","Block3","Replacement",first,token);}
      break;
    case TRY:
      ...
      default:
        ...
        ;
                                                                                                                                                      ...
                                                                                                                                                      {if (true) return productionEndTerminal("expansion_unit4","Block4","Block4","Replacement",first,token);}
      break;
    default:
      jj_la1[34] = jj_gen;
      if (jj_2_3(2147483647)) {
        ...
        n = expansion_unitMain(true);
                                                                                                                                                                                                    replaceName(n);
                                                                                                                                                                                                                      {if (true) return productionEndTerminal("expansion_unit5","Block5","Block5","Replacement",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LPAREN:
          jj_consume_token(LPAREN);
          ...
          default:
            ...
            ;
                                                                                                     ...
                                                                                                     {if (true) return productionEndTerminal("expansion_unit6","Block6","Block6","ExpansionOverriding",first,token);}
          break;
        default:
          jj_la1[35] = jj_gen;
          jj_consume_token(-1);
