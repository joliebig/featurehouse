...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor  {
	...
	public boolean visit(FSTNonTerminal nonTerminal) {
		if (nonTerminal.getType().equals("CompilationUnit1")) {
		...
		if (nonTerminal.getType().equals("CompilationUnit2")) {
			printFeatures(nonTerminal,true);
			{
		...
		if (nonTerminal.getType().equals("CompilationUnit3")) {
			printFeatures(nonTerminal,true);
			{
	...
	protected boolean isSubtype(String type, String expectedType) {
		...
		if (type.equals("BlockStatement6") && expectedType.equals("BlockStatement")) return true;
		if (type.equals("ExplicitConstructorInvocation1") && expectedType.equals("ExplicitConstructorInvocation")) return true;
		if (type.equals("BlockStatement7") && expectedType.equals("BlockStatement")) return true;
		...
		if (type.equals("VariableInitializer3") && expectedType.equals("VariableInitializer")) return true;
		...
		if (type.equals("BlockStatement5") && expectedType.equals("BlockStatement")) return true;
		...
		if (type.equals("AssignmentOperator14") && expectedType.equals("AssignmentOperator")) return true;
		...
		if (type.equals("AssignmentOperator13") && expectedType.equals("AssignmentOperator")) return true;
		if (type.equals("ForStatementInternal5") && expectedType.equals("ForStatementInternal")) return true;
		...
		if (type.equals("ForStatementInternal4") && expectedType.equals("ForStatementInternal")) return true;
		...
		if (type.equals("CompilationUnit1") && expectedType.equals("CompilationUnit")) return true;
		...
		if (type.equals("CompilationUnit2") && expectedType.equals("CompilationUnit")) return true;
		...
		if (type.equals("CompilationUnit3") && expectedType.equals("CompilationUnit")) return true;
		...
		if (type.equals("ConditionalExpression5") && expectedType.equals("ConditionalExpression")) return true;
		...
		if (type.equals("AllocationExpressionInit4") && expectedType.equals("AllocationExpressionInit")) return true;
		...
		if (type.equals("AllocationExpressionInit3") && expectedType.equals("AllocationExpressionInit")) return true;
		...
		if (type.equals("ConditionalExpression3") && expectedType.equals("ConditionalExpression")) return true;
		if (type.equals("BlockStatement8") && expectedType.equals("BlockStatement")) return true;
		...
		if (type.equals("BlockStatement9") && expectedType.equals("BlockStatement")) return true;
		if (type.equals("CastLAOp1") && expectedType.equals("CastLAOp")) return true;
		if (type.equals("ConditionalExpression4") && expectedType.equals("ConditionalExpression")) return true;
