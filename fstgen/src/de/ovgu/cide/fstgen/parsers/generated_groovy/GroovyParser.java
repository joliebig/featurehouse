/* Generated By:JavaCC: Do not edit this line. GroovyParser.java */
...
public class GroovyParser extends AbstractFSTParser implements GroovyParserConstants {
        public GroovyParser(){}
  ...
  final public FSTInfo CompilationUnit(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_1(2)) {
      ...
      jj_consume_token(0);
                                                                                                                                                                                                                              {if (true) return productionEndNonTerminal("CompilationUnit1","{TypeDeclaration}","{TypeDeclaration}");}
    } else if (jj_2_2(2)) {
      n = Expression(inTerminal);
                                               replaceName(n);
                                                                 {if (true) return productionEndNonTerminal("CompilationUnit2","{TypeDeclaration}","{TypeDeclaration}");}
    } else if (jj_2_3(2)) {
      n = Statement(inTerminal);
                                              replaceName(n);
                                                                {if (true) return productionEndNonTerminal("CompilationUnit3","{TypeDeclaration}","{TypeDeclaration}");}
    } else {
      jj_consume_token(-1);
  ...
  final public FSTInfo EmptyMapInitializer(boolean inTerminal) throws ParseException {
                                                    Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LBRACKET);
    jj_consume_token(COLON);
    jj_consume_token(RBRACKET);
                         {if (true) return productionEndTerminal("EmptyMapInitializer","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo EmptyListInitializer(boolean inTerminal) throws ParseException {
                                                     Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LBRACKET);
    jj_consume_token(RBRACKET);
                  {if (true) return productionEndTerminal("EmptyListInitializer","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo VariableInitializer(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_15(2)) {
      ...
      case MINUS:
        n = Expression(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("VariableInitializer3","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[46] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo AssignmentOperator(boolean inTerminal) throws ParseException {
    ...
    case LSHIFT:
      jj_consume_token(LSHIFT);
               {if (true) return productionEndTerminal("AssignmentOperator13","-","-","Replacement","Default",first,token);}
      break;
    case IN:
      jj_consume_token(IN);
               {if (true) return productionEndTerminal("AssignmentOperator14","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[71] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo ConditionalExpression(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_30(2147483647)) {
      ...
      n = ClosureExpression(true);
                                                replaceName(n);
                                                                  {if (true) return productionEndTerminal("ConditionalExpression3","-","-","Replacement","Default",first,token);}
    } else if (jj_2_33(3)) {
      n = MapInitializer(true);
                                             replaceName(n);
                                                               {if (true) return productionEndTerminal("ConditionalExpression4","-","-","Replacement","Default",first,token);}
    } else if (jj_2_34(3)) {
      n = ArrayCreation(true);
                                            replaceName(n);
                                                              {if (true) return productionEndTerminal("ConditionalExpression5","-","-","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo MapInitializer(boolean inTerminal) throws ParseException {
                                               Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LBRACKET);
    n = Expression(true);
    ...
    while (true) {
      ...
      n = MapInitializarInternal(true);
                                                                                                                           replaceName(n);
    }
    jj_consume_token(RBRACKET);
                                                                                                                                                   {if (true) return productionEndTerminal("MapInitializer","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo MapInitializarInternal(boolean inTerminal) throws ParseException {
                                                       Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(COMMA);
    n = Expression(true);
    ...
    n = Expression(true);
                                                                             replaceName(n);
                                                                                               {if (true) return productionEndTerminal("MapInitializarInternal","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ClosureExpression(boolean inTerminal) throws ParseException {
                                                  Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LBRACE);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    while (true) {
      ...
      n = ClosureParameterInitializer(true);
                                                                 replaceName(n);
    }
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ARROW:
    ...
    jj_consume_token(RBRACE);
                                                                                                                                           {if (true) return productionEndTerminal("ClosureExpression","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ClosureParameterInitializer(boolean inTerminal) throws ParseException {
                                                            Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(COMMA);
    jj_consume_token(IDENTIFIER);
                              {if (true) return productionEndTerminal("ClosureParameterInitializer","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ArrayCreation(boolean inTerminal) throws ParseException {
                                              Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(LPAREN);
    n = Expression(true);
    ...
    n = Expression(true);
                                                                          replaceName(n);
    jj_consume_token(RPAREN);
                                                                                                {if (true) return productionEndTerminal("ArrayCreation","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
        ...
        if (jj_2_44(3)) {
          ...
          case LPAREN:
            ...
            n = ArgumentList(true);
                                  replaceName(n);
            jj_consume_token(RPAREN);
                                                        {if (true) return productionEndTerminal("PrimaryPrefix9","-","-","Replacement","Default",first,token);}
            break;
          default:
            jj_la1[103] = jj_gen;
            jj_consume_token(-1);
  ...
  final public FSTInfo AllocationExpressionInit(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_53(5)) {
      ...
      case LBRACKET:
        n = ArrayDimsAndInits(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("AllocationExpressionInit3","-","-","Replacement","Default",first,token);}
        break;
      case LPAREN:
        n = Arguments(true);
                           replaceName(n);
        ...
        default:
          ...
          ;
                                                                                              ...
                                                                                              {if (true) return productionEndTerminal("AllocationExpressionInit4","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[113] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo ExpandoParameter(boolean inTerminal) throws ParseException {
                                                 Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = Expression(true);
                            replaceName(n);
    ...
    n = Expression(true);
                                                                     replaceName(n);
                                                                                       {if (true) return productionEndTerminal("ExpandoParameter","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo BlockStatement(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_59(2147483647)) {
      ...
      case COMMA:
        jj_consume_token(COMMA);
                 {if (true) return productionEndTerminal("BlockStatement5","-","-","Replacement","Default",first,token);}
        break;
      case ARROW:
        jj_consume_token(ARROW);
                 {if (true) return productionEndTerminal("BlockStatement6","-","-","Replacement","Default",first,token);}
        break;
      case DOT:
        jj_consume_token(DOT);
               {if (true) return productionEndTerminal("BlockStatement7","-","-","Replacement","Default",first,token);}
        break;
      case SPREAD:
        jj_consume_token(SPREAD);
                  {if (true) return productionEndTerminal("BlockStatement8","-","-","Replacement","Default",first,token);}
        break;
      case SAFE:
        jj_consume_token(SAFE);
                {if (true) return productionEndTerminal("BlockStatement9","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[124] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo ForStatementInternal(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_60(3)) {
      ...
      n = Expression(true);
                                                                                                                                                           replaceName(n);
                                                                                                                                                                             {if (true) return productionEndTerminal("ForStatementInternal4","-","-","Replacement","Default",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case BOOLEAN:
      case BYTE:
      ...
      case DECR:
        ...
        default:
          ...
          ;
                                                                                                                                  ...
                                                                                                                                  {if (true) return productionEndTerminal("ForStatementInternal5","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[139] = jj_gen;
        jj_consume_token(-1);
  ...
  public GroovyParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x4020000,0x0,0x0,0x0,0x0,0x20000,0x86520000,0x0,0x0,0x0,0x86520000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x0,0x0,0x0,0x0,0x0,0x86520000,0x0,0x0,0x0,0x0,0x0,0x0,0x86520000,0x0,0x0,0x0,0x86520000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x82500000,0x82500000,0x0,0x0,0x0,0x0,0x0,0x82500000,0x0,0x0,0x0,0x0,0x0,0xd67a0000,0x82500000,0x0,0x82500000,0x82500000,0x0,0x0,0x82500000,0x0,0x82500000,0x82500000,0x0,0x0,0x0,0x0,0x0,0x0,0x82500000,0x82500000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x82500000,0x0,0x82500000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x82500000,0x0,0x0,0x0,0x82500000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xd2780000,0x0,0x0,0xd67a0000,0x0,0xd67a0000,0x0,0x0,0x0,0x82500000,0x0,0x20800000,0xd67a0000,0x20800000,0x0,0x0,0x0,0x82500000,0x82500000,0x82500000,0x82500000,0x82500000,0x0,0x0,0x0,0x0,0x0,0x82500000,0x0,0x0,0x1000000,0x0,0x1000000,0x0,0x0,0x0,0x82500000,0x0,0x86520000,0x20000000,0x86520000,0x0,0x0,0x0,0x86520000,0x0,0x0,0x0,0x4020000,0x82520000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x100000,0x800,0x4ce28012,0x0,0x4000000,0x0,0x0,0x4ce20010,0x4ee3c052,0x0,0x4,0x400,0xdeefc05a,0x400,0x0,0x0,0x0,0x0,0x4,0x400,0x8000,0x0,0x0,0x400,0x0,0x0,0xdeefc05a,0x0,0x0,0x0,0x0,0x4,0x0,0xdeefc05a,0x0,0x4,0x400,0xdeefc05a,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x920d4048,0x920d4048,0x0,0x0,0x0,0x0,0x0,0x2014050,0x0,0x10,0x0,0x0,0x0,0xffefcad8,0x920d4048,0x4000000,0x2014040,0x2014040,0x0,0x10000004,0x2014040,0x10000004,0x2014040,0x2014040,0x0,0x1000,0x0,0x0,0x0,0x0,0x920d4048,0x920d4048,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x920d4048,0x0,0x920d4048,0x0,0x0,0x900c0008,0x0,0x0,0x0,0x90000000,0x0,0x0,0x80008,0x8,0x920d4048,0x0,0x0,0x40000,0x920d4048,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf30d4ac8,0x0,0x0,0xffefcad8,0x0,0xffefcad8,0x10,0x0,0x1000,0x920d4048,0x1000,0x0,0xffefcad8,0x0,0x1,0x0,0x10,0x920d4058,0x920d4048,0x920d4048,0x920d4058,0x920d4048,0x0,0x0,0x0,0x0,0x0,0x920d4048,0x0,0x0,0x0,0x20,0x20,0x0,0x0,0x0,0x920d4048,0x0,0x4ee3c052,0x0,0x4ee3c052,0x0,0x4,0x400,0xdeefc05a,0x400,0x0,0x0,0x4ce28010,0x4ee34050,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x24000088,0x4000000,0x0,0x10000000,0x4000000,0x20000088,0x24020088,0x80000000,0x0,0x0,0xa553a2d8,0x0,0x8000000,0x4000000,0x4000000,0x80000000,0x0,0x0,0x0,0x8000000,0x8000000,0x0,0x8000000,0x4000000,0xa553a2d8,0x100000,0x400000,0x20000,0x8000000,0x0,0x0,0xa553a2d8,0x80000000,0x0,0x0,0xa553a2d8,0x0,0x8000000,0x4000000,0x4000000,0x8000000,0x4000000,0x40000000,0x1000000,0x153a250,0x153a250,0x8000000,0x80000000,0x4,0x4400000,0x1000000,0x20020000,0x8000000,0x0,0x0,0x80000000,0x4,0x3d53a3fa,0x113a250,0x0,0x0,0x20000,0x8000000,0x0,0x20000,0x0,0x0,0x20040,0x8000000,0x40000000,0x8000000,0x20000,0x8000000,0x0,0x153a250,0x153a250,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x113a250,0x0,0x113a250,0x0,0x100000,0x13a210,0x0,0x0,0x100000,0x0,0x120000,0x11100000,0x1a210,0x10,0x153a250,0x8000000,0x80000000,0x0,0x153a250,0x400000,0x1100000,0x1000000,0x1000000,0x4000000,0x4000000,0x4000000,0x553a372,0x0,0x4000000,0x3d53a3fa,0x4000000,0x3d53a3fa,0x0,0x8000000,0x40000000,0x113a250,0x40000000,0x0,0x3d53a3fa,0x0,0x0,0x4000000,0x0,0x113a250,0x153a250,0x113a250,0x513a250,0x113a250,0x8000000,0x20000,0x4000000,0x20000,0x4000000,0x153a250,0x4000000,0x4000000,0x0,0x0,0x0,0x20000000,0x20000,0x8000000,0x2153a250,0x8000000,0x24020088,0x0,0x24020088,0x80000000,0x0,0x0,0xa553a2d8,0x0,0x8000000,0x4000000,0x20000088,0x24020088,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x10000,0x3c03,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc00,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0xfff00000,0x0,0x0,0x0,0x0,0x3c03,0x3c03,0x100,0x200,0x20000,0x40000,0x10000,0x90,0x90,0x0,0x60,0x60,0x100000,0x3000,0x3000,0x8c000,0x8c000,0x3c03,0x3,0x0,0x3,0x0,0x3,0xc00,0xc00,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc00,0x8,0x0,0xc00,0x0,0xc00,0x0,0x0,0xfff00c00,0xc00,0xfff00c00,0x0,0xc00,0x0,0x0,0x0,0x0,0xc00,0x3c03,0xc00,0xc00,0xc00,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c03,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe,0x0,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0xe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  final private JJCalls[] jj_2_rtns = new JJCalls[70];
  private boolean jj_rescan = false;
  private int jj_gc = 0;

  public GroovyParser(CharStream stream) {
    token_source = new GroovyParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public GroovyParser(GroovyParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(GroovyParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
