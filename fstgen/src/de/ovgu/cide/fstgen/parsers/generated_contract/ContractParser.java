/* Generated By:JavaCC: Do not edit this line. ContractParser.java */
 ...
 */
public class ContractParser extends AbstractFSTParser implements ContractParserConstants {
    ...
    while (true) {
      ...
      n = Modifier(true);
                                        replaceName(n);
                                                            ...
                                                            {if (true) return productionEndTerminal("Modifiers2","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo SpecCaseSeq(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      n = AlsoSpecCase(inTerminal);
                                                                                           replaceName(n);
    }
                                                                                                               {if (true) return productionEndNonTerminal("SpecCaseSeq","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo AlsoSpecCase(boolean inTerminal) throws ParseException {
    ...
    n = SpecCase(inTerminal);
                                       replaceName(n);
                                                         {if (true) return productionEndNonTerminal("AlsoSpecCase","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo GenericSpecCase(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_393(4)) {
      n = OriginalCaseKeyword(inTerminal);
                                           replaceName(n);
                                                             {if (true) return productionEndNonTerminal("GenericSpecCase1","-","-");}
    } else if (jj_2_394(4)) {
      if (jj_2_390(4)) {
      ...
      if (jj_2_391(4)) {
        ...
        ;
                                                                                                                                                     ...
                                                                                                                                                     {if (true) return productionEndNonTerminal("GenericSpecCase2","-","-");}
    } else if (jj_2_395(4)) {
      if (jj_2_392(4)) {
        n = SpecVarDecls(inTerminal);
                                     replaceName(n);
      ...
      n = GenericSpecBody(inTerminal);
                                                                                      replaceName(n);
                                                                                                        {if (true) return productionEndNonTerminal("GenericSpecCase3","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo BehaviorSpecCase(boolean inTerminal) throws ParseException {
    ...
    n = BehaviorKeyword(inTerminal);
                                                                                          replaceName(n);
    n = GenericSpecCase(inTerminal);
                                                                                                                                          replaceName(n);
                                                                                                                                                            {if (true) return productionEndNonTerminal("BehaviorSpecCase","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo BehaviorKeyword(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_403(4)) {
      jj_consume_token(BEHAVIOR);
                    {if (true) return productionEndNonTerminal("BehaviorKeyword1","-","-");}
    } else if (jj_2_404(4)) {
      jj_consume_token(BEHAVIOUR);
                     {if (true) return productionEndNonTerminal("BehaviorKeyword2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo NormalBehaviorKeyword(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_407(4)) {
      jj_consume_token(NORMAL_BEHAVIOR);
                           {if (true) return productionEndNonTerminal("NormalBehaviorKeyword1","-","-");}
    } else if (jj_2_408(4)) {
      jj_consume_token(NORMAL_BEHAVIOUR);
                            {if (true) return productionEndNonTerminal("NormalBehaviorKeyword2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo ExceptionalBehaviorSpecCase(boolean inTerminal) throws ParseException {
    ...
    n = ExceptionalBehaviorKeyword(inTerminal);
                                                                                                     replaceName(n);
    n = ExceptionalSpecCase(inTerminal);
                                                                                                                                                         replaceName(n);
                                                                                                                                                                           {if (true) return productionEndNonTerminal("ExceptionalBehaviorSpecCase","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ExceptionalBehaviorKeyword(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_411(4)) {
      jj_consume_token(EXCEPTIONAL_BEHAVIOR);
                                {if (true) return productionEndNonTerminal("ExceptionalBehaviorKeyword1","-","-");}
    } else if (jj_2_412(4)) {
      jj_consume_token(EXCEPTIONAL_BEHAVIOUR);
                                 {if (true) return productionEndNonTerminal("ExceptionalBehaviorKeyword2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo ExceptionalSpecCase(boolean inTerminal) throws ParseException {
    ...
    n = GenericSpecCase(inTerminal);
                                       replaceName(n);
                                                         {if (true) return productionEndNonTerminal("ExceptionalSpecCase","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo SpecVarDecls(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_414(4)) {
      n = ForallVarDecls(inTerminal);
                                      replaceName(n);
      if (jj_2_413(4)) {
        n = OldVarDecls(inTerminal);
                                                                                   replaceName(n);
      } else {
        ;
      }
                                                                                                      {if (true) return productionEndNonTerminal("SpecVarDecls1","-","-");}
    } else if (jj_2_415(4)) {
      n = OldVarDecls(inTerminal);
                                   replaceName(n);
                                                     {if (true) return productionEndNonTerminal("SpecVarDecls2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo ForallVarDecls(boolean inTerminal) throws ParseException {
                                               Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = ForallVarDeclarator(inTerminal);
                                           replaceName(n);
    label_71:
    while (true) {
      if (jj_2_416(4)) {
      ...
      n = ForallVarDeclarator(inTerminal);
                                                                                                replaceName(n);
                                                                                                                    ...
                                                                                                                    {if (true) return productionEndNonTerminal("ForallVarDecls","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ForallVarDeclarator(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_417(4)) {
      n = BoundVarModifiers(inTerminal);
                                                   replaceName(n);
    } else {
      ;
    }
    n = TypeSpec(inTerminal);
                                                                                             replaceName(n);
    n = QuantifiedVarDeclarator(inTerminal);
                                                                                                                                                     replaceName(n);
    jj_consume_token(SEMICOLON);
                                                                                                                                                                                   {if (true) return productionEndNonTerminal("ForallVarDeclarator","-","-");}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = OldVarDeclarator(inTerminal);
                                                                                          replaceName(n);
                                                                                                              ...
                                                                                                              {if (true) return productionEndNonTerminal("OldVarDecls","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo OldVarDeclarator(boolean inTerminal) throws ParseException {
    ...
    n = TypeSpec(inTerminal);
                                                                                          replaceName(n);
    n = SpecVariableDeclarators(inTerminal);
                                                                                                                                                  replaceName(n);
    jj_consume_token(SEMICOLON);
                                                                                                                                                                                {if (true) return productionEndNonTerminal("OldVarDeclarator","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  public ContractParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x40000000,0x1010000,0x20950000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x899c5004,0x89dc6814,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x7f7bf808,0x7f7bf808,};
   }
   ...
   private static void jj_la1_7() {
      jj_la1_7 = new int[] {0x0,0x80000,0x80080,};
   }
  ...
  public ContractParser(CharStream stream) {
    token_source = new ContractParserTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public ContractParser(ContractParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(ContractParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
