...
public class JavaCCParser extends AbstractFSTParser implements JavaCCParserConstants {
  ...
  final public FSTInfo javacc_input(boolean inTerminal) throws ParseException {
    ...
    n = ParserNameS(inTerminal);
                                                                                                       replaceName(n);
    jj_consume_token(RPAREN);
    n = CompilationUnit(inTerminal);
                                                                                                                                                           replaceName(n);
    jj_consume_token(_PARSER_END);
    jj_consume_token(LPAREN);
    n = ParserNameE(inTerminal);
                                                                                                                                                                                                                        replaceName(n);
    jj_consume_token(RPAREN);
    label_1:
    while (true) {
  ...
  final public FSTInfo ParserNameS(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("ParserNameS","ParserNameS","ParserNameS","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ParserNameE(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("ParserNameE","ParserNameE","ParserNameE","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo option_binding(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
                                                                                                                            {if (true) return productionEndTerminal("option_binding","{OptionName}","{OptionName}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo OptionName(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("OptionName1","-","{TOSTRING}","Replacement","Default",first,token);}
      break;
    case _LOOKAHEAD:
      jj_consume_token(_LOOKAHEAD);
                      {if (true) return productionEndTerminal("OptionName2","-","{TOSTRING}","Replacement","Default",first,token);}
      break;
    case _IGNORE_CASE:
      jj_consume_token(_IGNORE_CASE);
                        {if (true) return productionEndTerminal("OptionName3","-","{TOSTRING}","Replacement","Default",first,token);}
      break;
    case STATIC:
      jj_consume_token(STATIC);
                   {if (true) return productionEndTerminal("OptionName4","-","{TOSTRING}","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo OptionValue(boolean inTerminal) throws ParseException {
    ...
    case INTEGER_LITERAL:
      jj_consume_token(INTEGER_LITERAL);
                           {if (true) return productionEndTerminal("OptionValue1","-","-","Replacement","Default",first,token);}
      break;
    case FALSE:
    case TRUE:
      n = BooleanLiteral(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("OptionValue2","-","-","Replacement","Default",first,token);}
      break;
    case STRING_LITERAL:
      jj_consume_token(STRING_LITERAL);
                          {if (true) return productionEndTerminal("OptionValue3","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[4] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo production(boolean inTerminal) throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case _JAVACODE:
      n = javacode_production(true);
                                                  replaceName(n);
                                                                    {if (true) return productionEndTerminal("production1","-","-","Replacement","Default",first,token);}
      break;
    case _TOKEN:
    case _SPECIAL_TOKEN:
    case _MORE:
    ...
    case LT:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LT:
        n = regular_expr_productionPrefix(inTerminal);
                                                      replaceName(n);
        break;
      default:
        jj_la1[5] = jj_gen;
      ...
      break;
    case _TOKEN_MGR_DECLS:
      n = token_manager_decls(true);
                                                  replaceName(n);
                                                                    {if (true) return productionEndTerminal("production3","-","-","Replacement","Default",first,token);}
      break;
    case _OPTIONS:
    case _LOOKAHEAD:
    case _IGNORE_CASE:
    ...
    case IDENTIFIER:
      ...
      n = Block(inTerminal);
                                                                                                                                                                                                                                                                                                                                        replaceName(n);
      jj_consume_token(LBRACE);
      n = expansion_choices(inTerminal);
                                                                                                                                                                                                                                                                                                                                                                                              replaceName(n);
      jj_consume_token(RBRACE);
  ...
  final public FSTInfo javacode_production(boolean inTerminal) throws ParseException {
    ...
    n = Block(true);
                                                                                                                                                                                                                   replaceName(n);
                                                                                                                                                                                                                                     {if (true) return productionEndTerminal("javacode_production","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = Name(true);
                                                                   replaceName(n);
                                                                                       ...
                                                                                       {if (true) return productionEndTerminal("ThrowsClause","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo bnf_production(boolean inTerminal) throws ParseException {
    ...
    n = Block(true);
                                                                                                                                                                                                                                 replaceName(n);
    jj_consume_token(LBRACE);
    n = expansion_choices(true);
                                                                                                                                                                                                                                                                                 replaceName(n);
    jj_consume_token(RBRACE);
                                                                                                                                                                                                                                                                                                       {if (true) return productionEndTerminal("bnf_production","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo BNFName(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("BNFName","-","{TOSTRING}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo AccessModifier(boolean inTerminal) throws ParseException {
    ...
    case PUBLIC:
      jj_consume_token(PUBLIC);
                   {if (true) return productionEndTerminal("AccessModifier","-","-","ModifierListSpecialization","Default",first,token);}
      break;
    case PROTECTED:
  ...
  final public FSTInfo regular_expr_production(boolean inTerminal) throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LT:
      n = regular_expr_productionPrefix(true);
                                                replaceName(n);
      break;
    default:
      jj_la1[17] = jj_gen;
    ...
    jj_consume_token(RBRACE);
                                                                                                                                                                                                                                    {if (true) return productionEndTerminal("regular_expr_production","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo regular_expr_productionPrefix(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_1(2)) {
      ...
      jj_consume_token(GT);
                                   {if (true) return productionEndTerminal("regular_expr_productionPrefix1","-","-","Replacement","Default",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LT:
        jj_consume_token(LT);
        ...
        jj_consume_token(GT);
                                                  {if (true) return productionEndTerminal("regular_expr_productionPrefix2","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[21] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo token_manager_decls(boolean inTerminal) throws ParseException {
    ...
    n = ClassOrInterfaceBody(true);
                                                            replaceName(n);
                                                                              {if (true) return productionEndTerminal("token_manager_decls","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo regexpr_kind(boolean inTerminal) throws ParseException {
    ...
    case _TOKEN:
      jj_consume_token(_TOKEN);
                  {if (true) return productionEndTerminal("regexpr_kind1","-","-","Replacement","Default",first,token);}
      break;
    case _SPECIAL_TOKEN:
      jj_consume_token(_SPECIAL_TOKEN);
                          {if (true) return productionEndTerminal("regexpr_kind2","-","-","Replacement","Default",first,token);}
      break;
    case _SKIP:
      jj_consume_token(_SKIP);
                 {if (true) return productionEndTerminal("regexpr_kind3","-","-","Replacement","Default",first,token);}
      break;
    case _MORE:
      jj_consume_token(_MORE);
                 {if (true) return productionEndTerminal("regexpr_kind4","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[22] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo regexpr_spec(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                                                   ...
                                                                                                                                                   {if (true) return productionEndTerminal("regexpr_spec","{regular_expression}","{regular_expression}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo local_lookahead(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                           {if (true) return productionEndTerminal("local_lookahead","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo expansion_unit(boolean inTerminal) throws ParseException {
    ...
    case _LOOKAHEAD:
      jj_consume_token(_LOOKAHEAD);
      jj_consume_token(LPAREN);
      n = local_lookahead(true);
                                                              replaceName(n);
      jj_consume_token(RPAREN);
                                                                                    {if (true) return productionEndTerminal("expansion_unit1","Block1","Block1","Replacement","Default",first,token);}
      break;
    case LBRACE:
      n = Block(true);
                       replaceName(n);
                                         {if (true) return productionEndTerminal("expansion_unit2","Block2","Block2","ExpansionOverriding","Default",first,token);}
      break;
    case LBRACKET:
      jj_consume_token(LBRACKET);
      n = expansion_choices(true);
                                       replaceName(n);
      jj_consume_token(RBRACKET);
                                                             {if (true) return productionEndTerminal("expansion_unit3","Block3","Block3","Replacement","Default",first,token);}
      break;
    case TRY:
      ...
      default:
        ...
        ;
                                                                                                                                                      ...
                                                                                                                                                      {if (true) return productionEndTerminal("expansion_unit4","Block4","Block4","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[34] = jj_gen;
      if (jj_2_3(2147483647)) {
        ...
        n = expansion_unitMain(true);
                                                                                                                                                                                                    replaceName(n);
                                                                                                                                                                                                                      {if (true) return productionEndTerminal("expansion_unit5","Block5","Block5","Replacement","Default",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LPAREN:
          jj_consume_token(LPAREN);
          ...
          default:
            ...
            ;
                                                                                                     ...
                                                                                                     {if (true) return productionEndTerminal("expansion_unit6","Block6","Block6","ExpansionOverriding","Default",first,token);}
          break;
        default:
          jj_la1[35] = jj_gen;
          jj_consume_token(-1);
  ...
  final public FSTInfo CatchPart(boolean inTerminal) throws ParseException {
    ...
    n = Block(true);
                                                                                   replaceName(n);
                                                                                                     {if (true) return productionEndTerminal("CatchPart","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo expansion_unitMain(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_4(2147483647)) {
      ...
      n = Arguments(true);
                                                                     replaceName(n);
                                                                                       {if (true) return productionEndTerminal("expansion_unitMain1","-","-","Replacement","Default",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case STRING_LITERAL:
      case LT:
        ...
        default:
          ...
          ;
                                                                         ...
                                                                         {if (true) return productionEndTerminal("expansion_unitMain2","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[37] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo ExpModifier(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("ExpModifier1","-","-","Replacement","Default",first,token);}
      break;
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("ExpModifier2","-","-","Replacement","Default",first,token);}
      break;
    case HOOK:
      jj_consume_token(HOOK);
              {if (true) return productionEndTerminal("ExpModifier3","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[38] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo regular_expression(boolean inTerminal) throws ParseException {
    ...
    case STRING_LITERAL:
      t = jj_consume_token(STRING_LITERAL);
                            replaceName(new FSTInfo("<STRING_LITERAL>",t.image));
                                                                                    {if (true) return productionEndTerminal("regular_expression1","-","{<STRING_LITERAL>}","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[40] = jj_gen;
      if (jj_2_5(3)) {
        ...
        n = complex_regular_expression_choices(true);
                                                                                                                                  replaceName(n);
        jj_consume_token(GT);
                                                                                                                                                        {if (true) return productionEndTerminal("regular_expression2","-","{RegId}","Replacement","Default",first,token);}
      } else if (jj_2_6(2)) {
        jj_consume_token(LT);
        t = jj_consume_token(IDENTIFIER);
                                         replaceName(new FSTInfo("<IDENTIFIER>",t.image));
        jj_consume_token(GT);
                                                                                                 {if (true) return productionEndTerminal("regular_expression3","-","{<IDENTIFIER>}","Replacement","Default",first,token);}
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case LT:
          jj_consume_token(LT);
          ...
          jj_consume_token(GT);
                        {if (true) return productionEndTerminal("EOFExpr","-","<EOF>","Replacement","Default",first,token);}
          break;
        default:
          jj_la1[41] = jj_gen;
          jj_consume_token(-1);
  ...
  final public FSTInfo RegId(boolean inTerminal) throws ParseException {
    ...
    t = jj_consume_token(IDENTIFIER);
                               replaceName(new FSTInfo("<IDENTIFIER>",t.image));
    jj_consume_token(COLON);
                                                                                       {if (true) return productionEndTerminal("RegId","-","{<IDENTIFIER>}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo complex_regular_expression_choices(boolean inTerminal) throws ParseException {
                                                                   Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = complex_regular_expression(true);
                                            replaceName(n);
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      n = complex_regular_expression(true);
                                                                                                      replaceName(n);
                                                                                                                          ...
                                                                                                                          {if (true) return productionEndTerminal("complex_regular_expression_choices","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo complex_regular_expression(boolean inTerminal) throws ParseException {
    ...
    label_11:
    while (true) {
      n = complex_regular_expression_unit(true);
                                                  replaceName(n);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case STRING_LITERAL:
      case LPAREN:
      ...
      default:
        ...
        break label_11;
                                                                      ...
                                                                      {if (true) return productionEndTerminal("complex_regular_expression","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo complex_regular_expression_unit(boolean inTerminal) throws ParseException {
    ...
    case STRING_LITERAL:
      jj_consume_token(STRING_LITERAL);
                          {if (true) return productionEndTerminal("complex_regular_expression_unit1","-","-","Replacement","Default",first,token);}
      break;
    case LT:
      jj_consume_token(LT);
      jj_consume_token(IDENTIFIER);
      jj_consume_token(GT);
                              {if (true) return productionEndTerminal("complex_regular_expression_unit2","-","-","Replacement","Default",first,token);}
      break;
    case LBRACKET:
    case TILDE:
      n = character_list(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("complex_regular_expression_unit3","-","-","Replacement","Default",first,token);}
      break;
    case LPAREN:
      jj_consume_token(LPAREN);
      n = complex_regular_expression_choices(true);
      ...
      default:
        ...
        ;
                                                                                                                      ...
                                                                                                                      {if (true) return productionEndTerminal("complex_regular_expression_unit4","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[46] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo CREUPostfix(boolean inTerminal) throws ParseException {
    ...
    case PLUS:
      jj_consume_token(PLUS);
              {if (true) return productionEndTerminal("CREUPostfix1","-","-","Replacement","Default",first,token);}
      break;
    case STAR:
      jj_consume_token(STAR);
              {if (true) return productionEndTerminal("CREUPostfix2","-","-","Replacement","Default",first,token);}
      break;
    case HOOK:
      jj_consume_token(HOOK);
              {if (true) return productionEndTerminal("CREUPostfix3","-","-","Replacement","Default",first,token);}
      break;
    case LBRACE:
      jj_consume_token(LBRACE);
      jj_consume_token(INTEGER_LITERAL);
      ...
      jj_consume_token(RBRACE);
                                                                             {if (true) return productionEndTerminal("CREUPostfix4","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[48] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo CREUPostfixPP(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                 ...
                                 {if (true) return productionEndTerminal("CREUPostfixPP","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo character_list(boolean inTerminal) throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case STRING_LITERAL:
      n = character_descriptorList(true);
                                                      replaceName(n);
      break;
    default:
      jj_la1[51] = jj_gen;
    ...
    jj_consume_token(RBRACKET);
                                                                             {if (true) return productionEndTerminal("character_list","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = character_descriptor(true);
                                                                                          replaceName(n);
                                                                                                              ...
                                                                                                              {if (true) return productionEndTerminal("character_descriptorList","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo character_descriptor(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                 ...
                                                 {if (true) return productionEndTerminal("character_descriptor","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo CompilationUnit(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      n = TypeDeclaration(true);
                                                                                                                                replaceName(n);
    }
                                                                                                                                                    {if (true) return productionEndTerminal("CompilationUnit","-","-","StringConcatenation","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ImportDeclaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
                                                                            {if (true) return productionEndTerminal("ImportDeclaration","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = Modifier(true);
                                        replaceName(n);
                                                            ...
                                                            {if (true) return productionEndTerminal("Modifiers","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo TypeDeclaration(boolean inTerminal) throws ParseException {
    ...
    case SEMICOLON:
      jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("TypeDeclaration1","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[61] = jj_gen;
      if (jj_2_7(2)) {
        ...
        n = ClassOrInterfaceDeclaration(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("TypeDeclaration2","-","-","Replacement","Default",first,token);}
      } else if (jj_2_8(2)) {
        n = Modifiers(true);
                                        replaceName(n);
        n = EnumDeclaration(true);
                                                                                  replaceName(n);
                                                                                                    {if (true) return productionEndTerminal("TypeDeclaration3","-","-","Replacement","Default",first,token);}
      } else if (jj_2_9(2)) {
        n = Modifiers(true);
                                        replaceName(n);
        n = AnnotationTypeDeclaration(true);
                                                                                            replaceName(n);
                                                                                                              {if (true) return productionEndTerminal("TypeDeclaration4","-","-","Replacement","Default",first,token);}
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
    ...
    while (true) {
      ...
      n = ClassOrInterfaceType(true);
                                                                                                       replaceName(n);
                                                                                                                           ...
                                                                                                                           {if (true) return productionEndTerminal("ImplementsList","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = ClassOrInterfaceBodyDeclaration(true);
                                                      replaceName(n);
                                                                          ...
                                                                          {if (true) return productionEndTerminal("EnumBodyInternal","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ClassOrInterfaceBodyDeclaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_10(2)) {
      n = Initializer(true);
                                          replaceName(n);
                                                            {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration1","-","-","Replacement","Default",first,token);}
    } else if (jj_2_11(2147483647)) {
      n = Modifiers(true);
                                                                     replaceName(n);
      n = ClassOrInterfaceDeclaration(true);
                                                                                                                           replaceName(n);
                                                                                                                                             {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration2","-","-","Replacement","Default",first,token);}
    } else if (jj_2_12(2147483647)) {
      n = Modifiers(true);
                                                         replaceName(n);
      n = EnumDeclaration(true);
                                                                                                   replaceName(n);
                                                                                                                     {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration3","-","-","Replacement","Default",first,token);}
    } else if (jj_2_13(2147483647)) {
      n = Modifiers(true);
                                                                                             replaceName(n);
      n = ConstructorDeclaration(true);
                                                                                                                                              replaceName(n);
                                                                                                                                                                {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration4","-","-","Replacement","Default",first,token);}
    } else if (jj_2_14(2147483647)) {
      n = Modifiers(true);
                                                                                                            replaceName(n);
      n = FieldDeclaration(true);
                                                                                                                                                       replaceName(n);
                                                                                                                                                                         {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration5","-","-","Replacement","Default",first,token);}
    } else if (jj_2_15(2)) {
      n = Modifiers(true);
                                        replaceName(n);
      n = MethodDeclaration(true);
                                                                                    replaceName(n);
                                                                                                      {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration6","-","-","Replacement","Default",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case SEMICOLON:
        jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("ClassOrInterfaceBodyDeclaration7","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[78] = jj_gen;
        jj_consume_token(-1);
  ...
  final public FSTInfo VariableDeclarator(boolean inTerminal) throws ParseException {
    ...
    default:
      ...
      ;
                                                                                                            ...
                                                                                                            {if (true) return productionEndTerminal("VariableDeclarator","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo VariableDeclaratorId(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      jj_consume_token(RBRACKET);
                                                              ...
                                                              {if (true) return productionEndTerminal("VariableDeclaratorId","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo MethodDeclaration(boolean inTerminal) throws ParseException {
    ...
    n = MethodDeclarationBody(true);
                                                                                                                                                                                                                replaceName(n);
                                                                                                                                                                                                                                  {if (true) return productionEndTerminal("MethodDeclaration","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo MethodDeclarator(boolean inTerminal) throws ParseException {
    ...
    while (true) {
      ...
      jj_consume_token(RBRACKET);
                                                                                                         ...
                                                                                                         {if (true) return productionEndTerminal("MethodDeclarator","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FormalParameters(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RPAREN);
                                                                                                                    {if (true) return productionEndTerminal("FormalParameters","{FormalParametersInternal}","{FormalParametersInternal}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ConstructorDeclaration(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                                                                                                                                                                                                                                                                                                                                               {if (true) return productionEndTerminal("ConstructorDeclaration","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ResultType(boolean inTerminal) throws ParseException {
    ...
    case VOID:
      jj_consume_token(VOID);
                 {if (true) return productionEndTerminal("ResultType","-","-","Replacement","Default",first,token);}
      break;
    case _OPTIONS:
    case _LOOKAHEAD:
    case _IGNORE_CASE:
  ...
  final public FSTInfo Block(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                                                             {if (true) return productionEndTerminal("Block","-","-","JavaMethodOverriding","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo TryStatementEnd(boolean inTerminal) throws ParseException {
    ...
    case FINALLY:
      ...
      n = Block(true);
                                 replaceName(n);
                                                   {if (true) return productionEndTerminal("FinallyBlock","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[169] = jj_gen;
      jj_consume_token(-1);
  ...
  final public FSTInfo AnnotationTypeMemberDeclaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_52(2147483647)) {
      ...
      jj_consume_token(SEMICOLON);
                                                                                                                                                                                                                             {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration1","-","-","Replacement","Default",first,token);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ABSTRACT:
      case CLASS:
      ...
      case 143:
        ...
        n = ClassOrInterfaceDeclaration(true);
                                                                                              replaceName(n);
                                                                                                                {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration2","-","-","Replacement","Default",first,token);}
        break;
      default:
        jj_la1[177] = jj_gen;
        if (jj_2_53(2)) {
          ...
          n = EnumDeclaration(true);
                                                                                  replaceName(n);
                                                                                                    {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration3","-","-","Replacement","Default",first,token);}
        } else if (jj_2_54(2)) {
          n = Modifiers(true);
                                        replaceName(n);
          n = AnnotationTypeDeclaration(true);
                                                                                            replaceName(n);
                                                                                                              {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration4","-","-","Replacement","Default",first,token);}
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case _OPTIONS:
          case _LOOKAHEAD:
          ...
          case 143:
            ...
            n = FieldDeclaration(true);
                                                                                   replaceName(n);
                                                                                                     {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration5","-","-","Replacement","Default",first,token);}
            break;
          case SEMICOLON:
            jj_consume_token(SEMICOLON);
              {if (true) return productionEndTerminal("AnnotationTypeMemberDeclaration6","-","-","Replacement","Default",first,token);}
            break;
          default:
            jj_la1[178] = jj_gen;
            jj_consume_token(-1);
  ...
  final public FSTInfo JavaIdentifier(boolean inTerminal) throws ParseException {
    ...
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
                      {if (true) return productionEndTerminal("JavaIdentifier1","-","-","Replacement","Default",first,token);}
      break;
    case _OPTIONS:
      jj_consume_token(_OPTIONS);
                    {if (true) return productionEndTerminal("JavaIdentifier2","-","-","Replacement","Default",first,token);}
      break;
    case _LOOKAHEAD:
      jj_consume_token(_LOOKAHEAD);
                      {if (true) return productionEndTerminal("JavaIdentifier3","-","-","Replacement","Default",first,token);}
      break;
    case _IGNORE_CASE:
      jj_consume_token(_IGNORE_CASE);
                        {if (true) return productionEndTerminal("JavaIdentifier4","-","-","Replacement","Default",first,token);}
      break;
    case _PARSER_BEGIN:
      jj_consume_token(_PARSER_BEGIN);
                         {if (true) return productionEndTerminal("JavaIdentifier5","-","-","Replacement","Default",first,token);}
      break;
    case _PARSER_END:
      jj_consume_token(_PARSER_END);
                       {if (true) return productionEndTerminal("JavaIdentifier6","-","-","Replacement","Default",first,token);}
      break;
    case _JAVACODE:
      jj_consume_token(_JAVACODE);
                     {if (true) return productionEndTerminal("JavaIdentifier7","-","-","Replacement","Default",first,token);}
      break;
    case _TOKEN:
      jj_consume_token(_TOKEN);
                  {if (true) return productionEndTerminal("JavaIdentifier8","-","-","Replacement","Default",first,token);}
      break;
    case _SPECIAL_TOKEN:
      jj_consume_token(_SPECIAL_TOKEN);
                          {if (true) return productionEndTerminal("JavaIdentifier9","-","-","Replacement","Default",first,token);}
      break;
    case _MORE:
      jj_consume_token(_MORE);
                 {if (true) return productionEndTerminal("JavaIdentifier10","-","-","Replacement","Default",first,token);}
      break;
    case _SKIP:
      jj_consume_token(_SKIP);
                 {if (true) return productionEndTerminal("JavaIdentifier11","-","-","Replacement","Default",first,token);}
      break;
    case _TOKEN_MGR_DECLS:
      jj_consume_token(_TOKEN_MGR_DECLS);
                            {if (true) return productionEndTerminal("JavaIdentifier12","-","-","Replacement","Default",first,token);}
      break;
    case _EOF:
      jj_consume_token(_EOF);
                {if (true) return productionEndTerminal("JavaIdentifier13","-","-","Replacement","Default",first,token);}
      break;
    default:
      jj_la1[179] = jj_gen;
      jj_consume_token(-1);
