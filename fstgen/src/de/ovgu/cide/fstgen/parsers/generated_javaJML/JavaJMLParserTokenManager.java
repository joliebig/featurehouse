/* Generated By:JavaCC: Do not edit this line. JavaJMLParserTokenManager.java */
...
import cide.gparser.*;
public class JavaJMLParserTokenManager implements JavaJMLParserConstants
{
...
public JavaJMLParserTokenManager(CharStream stream){
   input_stream = stream;
}
public JavaJMLParserTokenManager(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
