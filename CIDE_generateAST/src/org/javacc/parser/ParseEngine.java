...
public class ParseEngine extends JavaCCGlobals {
  ...
  static String buildLookaheadChecker(Lookahead[] conds, String[] actions) {
	...
	if (la.action_tokens.size() == 0) {
	  ...
	  for (java.util.Enumeration _enum = la.action_tokens.elements(); _enum.hasMoreElements();) {
	    t = (Token)_enum.nextElement();
	    retval += printToken(t);
	  }
  ...
  static void buildPhase1Routine(BNFProduction p) {
    ...
    if (p.parameter_list_tokens.size() != 0) {
      ...
      for (java.util.Enumeration _enum = p.parameter_list_tokens.elements(); _enum.hasMoreElements();) {
        t = (Token)_enum.nextElement();
        printToken(t, ostr);
      }
      printTrailingComments(t, ostr);
    ...
    for (java.util.Enumeration _enum = p.throws_list.elements(); _enum.hasMoreElements();) {
      ostr.print(", ");
      java.util.Vector name = (java.util.Vector)_enum.nextElement();
    ...
    if (p.declaration_tokens.size() != 0) {
      ...
      for (java.util.Enumeration _enum = p.declaration_tokens.elements(); _enum.hasMoreElements();) {
        t = (Token)_enum.nextElement();
        printToken(t, ostr);
      }
      printTrailingComments(t, ostr);
  ...
  static String phase1ExpansionGen(Expansion e) {
    ...
    if (e instanceof RegularExpression) {
      ...
      if (e_nrw.lhsTokens.size() != 0) {
        ...
        for (java.util.Enumeration _enum = e_nrw.lhsTokens.elements(); _enum.hasMoreElements();) {
          t = (Token)_enum.nextElement();
          retval += printToken(t);
        }
        retval += printTrailingComments(t);
      ...
      if (e_nrw.argument_tokens.size() != 0) {
        ...
        for (java.util.Enumeration _enum = e_nrw.argument_tokens.elements(); _enum.hasMoreElements();) {
          t = (Token)_enum.nextElement();
          retval += printToken(t);
        }
        retval += printTrailingComments(t);
      ...
      if (e_nrw.action_tokens.size() != 0) {
        ...
        for (java.util.Enumeration _enum = e_nrw.action_tokens.elements(); _enum.hasMoreElements();) {
          t = (Token)_enum.nextElement();
          retval += printToken(t);
        }
        retval += printTrailingComments(t);
      ...
      for (int i = 0; i < e_nrw.catchblks.size(); i++) {
        ...
        if (v.size() != 0) {
          ...
          for (java.util.Enumeration _enum = v.elements(); _enum.hasMoreElements();) {
            t = (Token)_enum.nextElement();
            retval += printToken(t);
          }
          retval += printTrailingComments(t);
      ...
      if (e_nrw.finallyblk != null) {
        ...
        if (e_nrw.finallyblk.size() != 0) {
          ...
          for (java.util.Enumeration _enum = e_nrw.finallyblk.elements(); _enum.hasMoreElements();) {
            t = (Token)_enum.nextElement();
            retval += printToken(t);
          }
          retval += printTrailingComments(t);
...
//System.out.println("minimumSize: line: " + eseq.line + ", column: " + eseq.column + ": " + minimumSize(eseq));//Test Code
  ...
  static void build(java.io.PrintWriter ps) {
    ...
    for (java.util.Enumeration _enum = bnfproductions.elements(); _enum.hasMoreElements();) {
      p = (NormalProduction)_enum.nextElement();
    ...
    for (java.util.Enumeration _enum = phase3table.elements(); _enum.hasMoreElements();) {
      buildPhase3Routine((Phase3Data)(_enum.nextElement()), false);
    }
