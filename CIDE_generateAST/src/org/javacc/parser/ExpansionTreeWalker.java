...
public class ExpansionTreeWalker {
  ...
  static void preOrderWalk(Expansion node, TreeWalkerOp opObj) {
    ...
    if (opObj.goDeeper(node)) {
      if (node instanceof Choice) {
        for (java.util.Enumeration _enum = ((Choice)node).choices.elements(); _enum.hasMoreElements();) {
          preOrderWalk((Expansion)_enum.nextElement(), opObj);
        }
      } else if (node instanceof Sequence) {
        for (java.util.Enumeration _enum = ((Sequence)node).units.elements(); _enum.hasMoreElements();) {
          preOrderWalk((Expansion)_enum.nextElement(), opObj);
        }
        ...
        for (java.util.Enumeration _enum = ((RChoice)node).choices.elements(); _enum.hasMoreElements();) {
          preOrderWalk((Expansion)_enum.nextElement(), opObj);
        }
      } else if (node instanceof RSequence) {
        for (java.util.Enumeration _enum = ((RSequence)node).units.elements(); _enum.hasMoreElements();) {
          preOrderWalk((Expansion)_enum.nextElement(), opObj);
        }
  ...
  static void postOrderWalk(Expansion node, TreeWalkerOp opObj) {
    if (opObj.goDeeper(node)) {
      if (node instanceof Choice) {
        for (java.util.Enumeration _enum = ((Choice)node).choices.elements(); _enum.hasMoreElements();) {
          postOrderWalk((Expansion)_enum.nextElement(), opObj);
        }
      } else if (node instanceof Sequence) {
        for (java.util.Enumeration _enum = ((Sequence)node).units.elements(); _enum.hasMoreElements();) {
          postOrderWalk((Expansion)_enum.nextElement(), opObj);
