  ...
  static public void start() throws MetaParseException {
    ...
    if (Options.getBuildParser()) {
      ...
      if (cu_to_insertion_point_1.size() != 0) {
        ...
        for (Enumeration _enum = cu_to_insertion_point_1.elements(); _enum.hasMoreElements();) {
      ...
      if (cu_to_insertion_point_2.size() != 0) {
        ...
        for (Enumeration _enum = cu_to_insertion_point_2.elements(); _enum.hasMoreElements();) {
          t = (Token)_enum.nextElement();
          printToken(t, ostr);
        }
      }
	...
	for (int i = 0; i < tokenMaskSize; i++) {
	  ...
	  for (Enumeration _enum = maskVals.elements(); _enum.hasMoreElements();) {
	    int[] tokenMask = (int[])(_enum.nextElement());
	...
	for (int i = 0; i < (tokenCount-1)/32 + 1; i++) {
      ...
      if (cu_from_insertion_point_2.size() != 0) {
        ...
        for (Enumeration _enum = cu_from_insertion_point_2.elements(); _enum.hasMoreElements();) {
          t = (Token)_enum.nextElement();
          printToken(t, ostr);
        }
