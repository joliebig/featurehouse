...
from win32com.client import DispatchBaseClass class  IAddinDesigner (DispatchBaseClass) :
...
from win32com.client import CoClassBaseClass class  AddinDesigner (CoClassBaseClass) :
...
IAddinDesigner_vtables_dispatch_ = 1 IAddinDesigner_vtables_ = [
] IAddinInstance_vtables_dispatch_ = 1 IAddinInstance_vtables_ = [
] _IDTExtensibility2_vtables_dispatch_ = 1 _IDTExtensibility2_vtables_ = [
