...
__author__ = "Neale Pickett <neale@woozle.org>, Tim Stone <tim@fourstonesExpressions.com>"
...
WORD_DELETED = "D" WORD_CHANGED = "C" STATE_KEY = 'saved state' class  DBDictClassifier (classifier.Classifier) :
...
NO_TRAINING_FLAG = 1 class  Trainer (object) :
