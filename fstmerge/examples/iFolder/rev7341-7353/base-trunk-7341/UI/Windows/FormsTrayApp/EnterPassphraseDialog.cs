     ...
     else
     {
      ...
      publicKey = Convert.ToBase64String(cert.GetPublicKey());
                 ...
                 else
                {
                    ...
                    {
                        Novell.iFolderCom.MyMessageBox mmb = new MyMessageBox(Resource.GetString("PassStoreErr"), resourceManager.GetString("$this.Text"), "", MyMessageBoxButtons.OK, MyMessageBoxIcon.Error);
                        mmb.ShowDialog();
                        mmb.Dispose();
                        return;
                    }
