  ...
  static public bool ClientUpdates(string domainID, out bool serverOld)
  {
   ...
   switch( update )
   {
    ...
    case UpdateResult.UpgradeNeeded:
     result = false;
     res = (int) MessageBox.Show(String.Format( resourceManager.GetString("UpgradeClientMsg"),newClientVersion) , resourceManager.GetString("UpgradeNeededTitle"), MessageBoxButtons.OKCancel);
    ...
    case UpdateResult.UpgradeAvailable:
     res = (int) MessageBox.Show(String.Format( resourceManager.GetString("UpgradeClientMsg"),newClientVersion) , resourceManager.GetString("UpgradeAvailableTitle"), MessageBoxButtons.OKCancel);
     if( res == (int) DialogResult.OK)
     {
      if(instance.ifWebService.RunClientUpdate(domainID, null))
      {
