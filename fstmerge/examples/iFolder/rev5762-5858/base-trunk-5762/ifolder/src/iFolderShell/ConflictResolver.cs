...
namespace Novell.iFolderCom
{
 ...
 public class ConflictResolver : System.Windows.Forms.Form
 {
  ...
  {
   string helpFile = Path.Combine(Path.Combine(Path.Combine(loadPath, "help"), iFolderAdvanced.GetLanguageDirectory()), @"doc\u0000\data\conflicts.html");
   if (!File.Exists(helpFile))
   {
    helpFile = Path.Combine(loadPath, @"help\en\doc\u0000\data\conflicts.html");
   }
   if (File.Exists(helpFile))
   {
