...
public class RtfImportMappings {
    ...
    private HashMap<String, List> listMappings = null;
    ...
    public RtfImportMappings() {
        ...
        this.listMappings = new HashMap<String, List>();
    ...
    public void addList(String listNr, List list) {
    ...
    public HashMap<String, List> getListMappings() {
