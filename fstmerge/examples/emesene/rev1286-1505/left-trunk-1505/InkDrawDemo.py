...
class InkDrawDemo(gtk.Window):
    def __init__(self, theme):
        ...
        self._color_label = InkDraw.ColorLabel(self._inkcanvas.stroke_color)
        color_button = InkDraw.ColorButton(self._color_label)
