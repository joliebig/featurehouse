...
public  class  ExternalFileType implements  Comparable<ExternalFileType> {
    ...
    <<<<<<< C:\Dokumente und Einstellungen\Sven Apel\Eigene Dateien\Uni\fstmerge\fstmerge_tmp\fstmerge_var1_44593
public ExternalFileType(String name, String extension, String mimeType,
                            String openWith, String iconName) {
=======
...
>>>>>>> C:\Dokumente und Einstellungen\Sven Apel\Eigene Dateien\Uni\fstmerge\fstmerge_tmp\fstmerge_var2_44595
        label.setText(null);
<<<<<<< C:\Dokumente und Einstellungen\Sven Apel\Eigene Dateien\Uni\fstmerge\fstmerge_tmp\fstmerge_var1_44593
        this.name = name;
        label.setToolTipText(this.name);
