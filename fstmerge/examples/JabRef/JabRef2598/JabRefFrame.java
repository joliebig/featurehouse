...
public JabRefPreferences prefs() {
  ...
  private void fillMenu() {
      ...
      edit.add(selectAll);
      mb.add(edit);
<<<<<<< C:\Dokumente und Einstellungen\Sven Apel\Eigene Dateien\Uni\fstmerge\fstmerge_tmp\fstmerge_var1_41353
      view.add(back);
      view.add(forward);
      view.add(focusTable);
=======
      view.add(focusTable);
>>>>>>> C:\Dokumente und Einstellungen\Sven Apel\Eigene Dateien\Uni\fstmerge\fstmerge_tmp\fstmerge_var2_41355
      view.add(nextTab);
      view.add(prevTab);
      view.add(sortTabs);
      view.addSeparator();
    ...
    protected void initActions() {
        ...
        openDatabaseOnlyActions.addAll(Arrays.asList(new Object[] { manageSelectors,
            ...
            incrementalSearch, replaceAll, importMenu, exportMenu, fetchCiteSeer,
                openPdf, openUrl, openFile, openSpires, togglePreview, dupliCheck,  highlightAll,
      ...
      public void actionPerformed( ActionEvent e )
      {
        ...
        if (dialog.okPressed())
        {
          BasePanel bp = new BasePanel( JabRefFrame.this,
                                        ...
                                        null,                     
                                        (HashMap<String,String>)null, Globals.prefs.get("defaultEncoding"));                     
