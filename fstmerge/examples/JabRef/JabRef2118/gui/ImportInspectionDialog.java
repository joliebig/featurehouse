...
public  class  ImportInspectionDialog  extends JDialog {
    ...
    class  EntrySelectionListener implements  ListEventListener ,  ListEventListener<BibtexEntry> {
    ...
    class  EntryTableFormat implements  TableFormat ,  TableFormat<BibtexEntry> {
