...
public  class  MainTableFormat implements  TableFormat ,  TableFormat<BibtexEntry> {
    ...
    static  class  NoSearchMatcher implements  Matcher ,  Matcher<BibtexEntry> {
    ...
    static  class  SearchMatcher implements  Matcher ,  Matcher<BibtexEntry> {
