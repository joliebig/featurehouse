...
class Question(Persistable):
    ...
    def __init__(self, idevice):
        ...
        Initialize 
        """
        self.question = TextAreaField(x_(u''), x_(u''), x_(u''))
        self.question.idevice = idevice
        self.feedback = TextAreaField(x_(u''), x_(u''), x_(u''))
...
in order to gain resolution of the situation.""")
        self.story = TextAreaField(x_(u'Story:'), self._storyInstruc, story)
        self.story.idevice = self
        self.questions    = []
