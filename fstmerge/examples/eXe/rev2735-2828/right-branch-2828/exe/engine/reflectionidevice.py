...
reflective feedback.)""")
        ...
        self.activity = TextAreaField(x_(u'Reflective question:'), self._activityInstruc, activity)
        self.activity.idevice = self
        self.answer = TextAreaField(x_(u'Feedback:'), self._answerInstruc, answer)
        self.answer.idevice = self
