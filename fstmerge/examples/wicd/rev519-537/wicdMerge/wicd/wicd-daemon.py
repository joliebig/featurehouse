...
if __name__ == '__main__':
    if os.getuid() != 0:
        print ("Root priviledges are required for the daemon to run properly." +               "  Exiting.")
        sys.exit(1)
    main(sys.argv)
...
class  ConnectionWizard (dbus.service.Object) :
	...
	<<<<<<< /work/joliebig/workspace_sple/featurehouse/fstmerge/fstmerge_tmp1309793763810/fstmerge_var1_8596708757000819940
@dbus.service.method('org.wicd.daemon')
    def Hello(self):
        """ Returns the version number.
        ...
        return version
=======
>>>>>>> /work/joliebig/workspace_sple/featurehouse/fstmerge/fstmerge_tmp1309793763810/fstmerge_var2_3657230917921525923
...
<<<<<<< /work/joliebig/workspace_sple/featurehouse/fstmerge/fstmerge_tmp1309793767987/fstmerge_var1_5536004506718153198
def usage():
    print """
wicd 1.5.4
...
"""
=======
>>>>>>> /work/joliebig/workspace_sple/featurehouse/fstmerge/fstmerge_tmp1309793767987/fstmerge_var2_1873867093151880695
