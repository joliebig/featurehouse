...
class  AsyncRunner (threading.Thread) :
	...
	def abort_if_needed(self):
        ...
        if self.cancel_event.isSet():
            ...
            logging.debug('aborting connection attempt')
	...
	def run(self):
        ...
        try:
            ...
            logging.debug( 'error occurred in AsyncRunner, exiting thread...')
        ...
        logging.debug('%s: AsyncRunner thread exited',
                      self.copied_method.func_name)
