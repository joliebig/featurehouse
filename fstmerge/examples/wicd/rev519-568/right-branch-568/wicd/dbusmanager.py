...
def do(interface_name, method, data=None):
    ...
    return interface.DoInterfaceAction(interface_name, method, data)
def get(interface_name, method, data=None):
    data = prepare_data_for_dbus(data)
    return interface.GetInterfaceData(interface_name, method, data)
def set(interface_name, method, data=None):
    data = prepare_data_for_dbus(data)
    return interface.SetInterfaceData(interface_name, method, data)
global dbus_manager
