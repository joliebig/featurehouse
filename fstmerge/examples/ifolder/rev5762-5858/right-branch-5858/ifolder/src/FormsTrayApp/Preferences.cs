...
namespace Novell.FormsTrayApp
{
 ...
 public class Preferences : System.Windows.Forms.Form
 {
  ...
  private void Preferences_Load(object sender, System.EventArgs e)
  {
   ...
   string helpFile = Path.Combine(Path.Combine(Path.Combine(Application.StartupPath, "help"), iFolderAdvanced.GetLanguageDirectory()), @"doc\u\data\preferences.html");
   if (!File.Exists(helpFile))
   {

    helpFile = Path.Combine(Application.StartupPath, @"help\en\doc\u\data\preferences.html");
   }
  ...
  private void tabControl1_SelectedIndexChanged(object sender, System.EventArgs e)
  {
   ...
   switch (tabControl1.SelectedIndex)
   {
    case 0:
     ...
     helpFile = Path.Combine(Path.Combine(Path.Combine(Application.StartupPath, "help"), iFolderAdvanced.GetLanguageDirectory()), @"doc\u\data\preferences.html");
     if (!File.Exists(helpFile))
     {
    ...
    case 1:
     ...
     helpFile = Path.Combine(Path.Combine(Path.Combine(Application.StartupPath, "help"), iFolderAdvanced.GetLanguageDirectory()), @"doc\u\data\accounts.html");
     if (!File.Exists(helpFile))
     {

      helpFile = Path.Combine(Application.StartupPath, @"help\en\doc\u\data\accounts.html");
     }
