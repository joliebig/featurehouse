...
namespace Novell.iFolderCom
{
 ...
 public class iFolderAdvanced : System.Windows.Forms.Form
 {
  ...
  private void iFolderAdvanced_Load(object sender, EventArgs e)
  {
   ...
   string helpFile = Path.Combine(Path.Combine(Path.Combine(loadPath, "help"), GetLanguageDirectory()), @"doc\u\data\sharewith.html");
   if (!File.Exists(helpFile))
   {

    helpFile = Path.Combine(loadPath, @"help\en\doc\u\data\sharewith.html");
   }
