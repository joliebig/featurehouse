...
namespace Novell.iFolderCom
{
 ...
 public class ConflictResolver : System.Windows.Forms.Form
 {
  ...
  private void ConflictResolver_Load(object sender, System.EventArgs e)
  {
   ...
   string helpFile = Path.Combine(Path.Combine(Path.Combine(loadPath, "help"), iFolderAdvanced.GetLanguageDirectory()), @"doc\u\data\conflicts.html");
   if (!File.Exists(helpFile))
   {

    helpFile = Path.Combine(loadPath, @"help\en\doc\u\data\conflicts.html");
   }
