...
namespace TaskbarLib.Interop
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        public static extern HResult SHCreateItemFromParsingName(string path, IntPtr pbc, ref Guid riid, [MarshalAs(UnmanagedType.Interface)] out IShellItem shellItem);
    }
}
